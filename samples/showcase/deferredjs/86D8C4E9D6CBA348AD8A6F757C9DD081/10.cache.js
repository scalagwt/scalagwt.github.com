...
defineSeed(756, 324, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$PopupListener, Q$UIObject, Q$Widget]), MenuBar_0);
...
defineSeed(763, 325, makeCastMap([Q$HasVisibility, Q$MenuItem, Q$UIObject]), MenuItem_0, MenuItem_1, MenuItem_3);
function $$init_624(){
}
...
defineSeed(764, 325, makeCastMap([Q$HasVisibility, Q$MenuItemSeparator, Q$UIObject]), MenuItemSeparator_0);
...
defineSeed(1003, 525, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), GenSeqViewLike$Filtered$$anonfun$index$2_0);
...
defineSeed(1005, 350, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1_0);
...
defineSeed(1040, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), Iterator$$anon$22_0);
...
defineSeed(1042, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), Iterator$$anon$5_0);
...
defineSeed(1043, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Iterator$$anonfun$toStream$1_0);
...
defineSeed(1090, 350, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), TraversableLike$$anonfun$flatMap$1_0);
...
defineSeed(1097, 1, makeCastMap([Q$ScalaObject, Q$Builder]), TraversableView$NoBuilder_0);
...
defineSeed(1118, 1, makeCastMap([Q$ScalaObject]), SliceInterval_0);
_.from$u0020 = 0;
_.until$u0020 = 0;
...
defineSeed(1119, 1, makeCastMap([Q$ScalaObject]), SliceInterval$_0);
var MODULE$_18;
...
defineSeed(1149, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), List$$anonfun$toStream$1_0);
...
defineSeed(1188, 1068, makeCastMap([Q$ScalaObject]), Stream$_0);
...
defineSeed(1190, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$1_0);
...
defineSeed(1191, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$append$1_0);
...
defineSeed(1192, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$filteredTail$1_0);
...
defineSeed(1193, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$flatMap$1_0);
...
defineSeed(1194, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$from$1_0);
...
defineSeed(1195, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$take$1_0);
...
defineSeed(1196, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$take$2_0);
...
defineSeed(1198, 1187, makeCastMap([Q$Serializable, Q$Equals, Q$Function1, Q$Immutable, Q$ScalaObject, Q$Serializable_0, Q$GenIterable, Q$GenIterableLike, Q$GenSeq, Q$GenTraversable, Q$GenTraversableLike, Q$GenTraversableOnce, Q$Iterable_0, Q$IterableLike, Q$LinearSeq, Q$LinearSeqLike, Q$LinearSeqOptimized, Q$Seq, Q$Traversable, Q$TraversableLike, Q$TraversableOnce, Q$FilterMonadic, Q$GenericTraversableTemplate, Q$HasNewBuilder, Q$Iterable_1, Q$Stream, Q$Traversable_0]), Stream$Cons_0);
...
defineSeed(1199, 1, makeCastMap([Q$ScalaObject]), Stream$ConsWrapper_0);
_.tl = null;
...
defineSeed(1200, 1187, makeCastMap([Q$Serializable, Q$Equals, Q$Function1, Q$Immutable, Q$ScalaObject, Q$Serializable_0, Q$GenIterable, Q$GenIterableLike, Q$GenSeq, Q$GenTraversable, Q$GenTraversableLike, Q$GenTraversableOnce, Q$Iterable_0, Q$IterableLike, Q$LinearSeq, Q$LinearSeqLike, Q$LinearSeqOptimized, Q$Seq, Q$Traversable, Q$TraversableLike, Q$TraversableOnce, Q$FilterMonadic, Q$GenericTraversableTemplate, Q$HasNewBuilder, Q$Iterable_1, Q$Stream, Q$Traversable_0]), Stream$Empty$_0);
...
defineSeed(1201, 1202, makeCastMap([Q$ScalaObject, Q$Stream$StreamBuilder, Q$Builder]), Stream$StreamBuilder_0);
...
defineSeed(1203, 350, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), Stream$StreamBuilder$$anonfun$result$1_0);
...
defineSeed(1204, 1104, makeCastMap([Q$ScalaObject]), Stream$StreamCanBuildFrom_0);
...
defineSeed(1205, 1, makeCastMap([Q$ScalaObject]), Stream$cons$_0);
var MODULE$_40;
function $$init_959(){
}
...
defineSeed(1206, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), StreamIterator_0);
...
defineSeed(1207, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$2_0);
...
defineSeed(1208, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$next$1_0);
...
defineSeed(1209, 991, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$toStream$1_0);
_.apply_3 = function apply_196(){
  return $apply_125();
}
;
function $$init_963(this$static){
}
...
defineSeed(1210, 1, makeCastMap([Q$ScalaObject]), StreamIterator$LazyCell_0);
_.bitmap$0 = 0;
_.st = null;
_.v$u0020 = null;
...
defineSeed(1226, 1225, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0, Q$ArrayBuilder$ofInt, Q$Builder]), ArrayBuilder$ofInt_0);
...
defineSeed(1230, 1229, makeCastMap([Q$Equals, Q$ScalaObject, Q$GenIterableLike, Q$GenTraversableLike, Q$GenTraversableOnce, Q$IndexedSeqLike, Q$IterableLike, Q$TraversableLike, Q$TraversableOnce, Q$FilterMonadic, Q$HasNewBuilder, Q$IndexedSeqLike_0]), ArrayOps$ofInt_0);
...
defineSeed(1253, 1, makeCastMap([Q$ScalaObject]), IndexedSeqView$_0);
var MODULE$_48;
function $$init_992(this$static){
}
...
defineSeed(1257, 1, {}, IndexedSeqView$$anon$7_0);
...
;
var Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$1', 460, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$3', 463, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$1', 467, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$5_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$5', 464, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqView$_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$', 1253, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$2', 468, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$7_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$7', 465, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$3', 469, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$9_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$9', 466, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$4_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$4', 470, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_MenuItemSeparator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MenuItemSeparator', 764, Lcom_google_gwt_user_client_ui_UIObject_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$11_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$11', 461, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$5_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$5', 471, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$7_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$7', 1257, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqLike$$anon$1_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqLike$$anon$1', 1251, Ljava_lang_Object_2_classLit), Lscala_collection_TraversableView$NoBuilder_2_classLit = createForClass('scala.collection.', 'TraversableView$NoBuilder', 1097, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$', 1188, Lscala_collection_generic_SeqFactory_2_classLit), Lscala_collection_immutable_Stream_2_classLit = createForClass('scala.collection.immutable.', 'Stream', 1187, Ljava_lang_Object_2_classLit), Lscala_collection_generic_SliceInterval$_2_classLit = createForClass('scala.collection.generic.', 'SliceInterval$', 1119, Ljava_lang_Object_2_classLit), Lscala_collection_generic_SliceInterval_2_classLit = createForClass('scala.collection.generic.', 'SliceInterval', 1118, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$cons$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$cons$', 1205, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$$anonfun$from$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$from$1', 1194, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$Cons_2_classLit = createForClass('scala.collection.immutable.', 'Stream$Cons', 1198, Lscala_collection_immutable_Stream_2_classLit), Lscala_collection_SeqViewLike$$anon$9_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$9', 1078, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$StreamCanBuildFrom_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamCanBuildFrom', 1204, Lscala_collection_generic_GenTraversableFactory$GenericCanBuildFrom_2_classLit), Lscala_collection_mutable_LazyBuilder_2_classLit = createForClass('scala.collection.mutable.', 'LazyBuilder', 1202, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$StreamBuilder_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamBuilder', 1201, Lscala_collection_mutable_LazyBuilder_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$2_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$2', 1255, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$1_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$1', 1254, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$Empty$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$Empty$', 1200, Lscala_collection_immutable_Stream_2_classLit), Lscala_collection_immutable_StreamIterator_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator', 1206, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_List$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.immutable.', 'List$$anonfun$toStream$1', 1149, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$StreamBuilder$$anonfun$result$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamBuilder$$anonfun$result$1', 1203, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_immutable_StreamIterator$LazyCell_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$LazyCell', 1210, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$2_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$2', 1207, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$take$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$take$1', 1195, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$take$2_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$take$2', 1196, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_Iterator$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.', 'Iterator$$anonfun$toStream$1', 1043, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$flatMap$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$flatMap$1', 1193, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$next$1_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$next$1', 1208, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$toStream$1', 1209, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$filteredTail$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$filteredTail$1', 1192, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_Iterator$$anon$5_2_classLit = createForClass('scala.collection.', 'Iterator$$anon$5', 1042, Ljava_lang_Object_2_classLit), Lscala_collection_TraversableLike$$anonfun$flatMap$1_2_classLit = createForClass('scala.collection.', 'TraversableLike$$anonfun$flatMap$1', 1090, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_immutable_Stream$$anonfun$append$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$append$1', 1191, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_GenSeqViewLike$Filtered$$anonfun$index$2_2_classLit = createForClass('scala.collection.', 'GenSeqViewLike$Filtered$$anonfun$index$2', 1003, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lscala_collection_mutable_ArrayOps$ofInt_2_classLit = createForClass('scala.collection.mutable.', 'ArrayOps$ofInt', 1230, Lscala_collection_mutable_ArrayOps_2_classLit), Lscala_collection_SeqViewLike$$anon$6_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$6', 1077, Ljava_lang_Object_2_classLit), Lscala_collection_SeqViewLike$$anon$5_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$5', 1076, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_ArrayBuilder$ofInt_2_classLit = createForClass('scala.collection.mutable.', 'ArrayBuilder$ofInt', 1226, Lscala_collection_mutable_ArrayBuilder_2_classLit), Lscala_collection_Iterator$$anon$22_2_classLit = createForClass('scala.collection.', 'Iterator$$anon$22', 1040, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$ConsWrapper_2_classLit = createForClass('scala.collection.immutable.', 'Stream$ConsWrapper', 1199, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$$anonfun$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$1', 1190, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$5_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$5', 1256, Ljava_lang_Object_2_classLit), Lscala_collection_SeqViewLike$$anon$11_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$11', 1074, Ljava_lang_Object_2_classLit), Lscala_collection_GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1_2_classLit = createForClass('scala.collection.', 'GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1', 1005, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(10);
