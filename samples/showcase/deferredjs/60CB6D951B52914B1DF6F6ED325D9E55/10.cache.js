...
defineSeed(675, 242, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$PopupListener, Q$UIObject, Q$Widget]), MenuBar_0);
...
defineSeed(682, 243, makeCastMap([Q$HasVisibility, Q$MenuItem, Q$UIObject]), MenuItem_0, MenuItem_1, MenuItem_3);
function $$init_541(){
}
...
defineSeed(683, 243, makeCastMap([Q$HasVisibility, Q$MenuItemSeparator, Q$UIObject]), MenuItemSeparator_0);
function $intArrayOps(xs){
  return new ArrayOps$ofInt_0(xs);
}

defineSeed(902, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]));
...
defineSeed(924, 443, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), GenSeqViewLike$Filtered$$anonfun$index$2_0);
...
defineSeed(926, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1_0);
...
;
defineSeed(959, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]));
...
defineSeed(961, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), Iterator$$anon$22_0);
...
defineSeed(963, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), Iterator$$anon$5_0);
...
defineSeed(964, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Iterator$$anonfun$toStream$1_0);
...
defineSeed(968, 1, makeCastMap([Q$Serializable, Q$Equals, Q$ScalaObject, Q$Serializable_0, Q$GenTraversableOnce, Q$JavaConversions$JIteratorWrapper, Q$TraversableOnce]));
...
defineSeed(1011, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), TraversableLike$$anonfun$flatMap$1_0);
...
defineSeed(1018, 1, makeCastMap([Q$ScalaObject, Q$Builder]), TraversableView$NoBuilder_0);
...
defineSeed(1039, 1, makeCastMap([Q$ScalaObject]), SliceInterval_0);
_.from$u0020 = 0;
_.until$u0020 = 0;
...
defineSeed(1040, 1, makeCastMap([Q$ScalaObject]), SliceInterval$_0);
var MODULE$_18;
...
defineSeed(1070, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), List$$anonfun$toStream$1_0);
...
defineSeed(1109, 989, makeCastMap([Q$ScalaObject]), Stream$_0);
...
defineSeed(1111, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$1_0);
...
defineSeed(1112, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$append$1_0);
...
defineSeed(1113, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$filteredTail$1_0);
...
defineSeed(1114, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$flatMap$1_0);
...
defineSeed(1115, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$from$1_0);
...
defineSeed(1116, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$take$1_0);
...
defineSeed(1117, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$take$2_0);
...
defineSeed(1119, 1108, makeCastMap([Q$Serializable, Q$Equals, Q$Function1, Q$Immutable, Q$ScalaObject, Q$Serializable_0, Q$GenIterable, Q$GenIterableLike, Q$GenSeq, Q$GenTraversable, Q$GenTraversableLike, Q$GenTraversableOnce, Q$Iterable_0, Q$IterableLike, Q$LinearSeq, Q$LinearSeqLike, Q$LinearSeqOptimized, Q$Seq, Q$Traversable, Q$TraversableLike, Q$TraversableOnce, Q$FilterMonadic, Q$GenericTraversableTemplate, Q$HasNewBuilder, Q$Iterable_1, Q$Stream, Q$Traversable_0]), Stream$Cons_0);
...
defineSeed(1120, 1, makeCastMap([Q$ScalaObject]), Stream$ConsWrapper_0);
_.tl = null;
...
defineSeed(1123, 1, makeCastMap([Q$ScalaObject, Q$Builder]));
...
defineSeed(1122, 1123, makeCastMap([Q$ScalaObject, Q$Stream$StreamBuilder, Q$Builder]), Stream$StreamBuilder_0);
...
defineSeed(1124, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), Stream$StreamBuilder$$anonfun$result$1_0);
...
defineSeed(1125, 1025, makeCastMap([Q$ScalaObject]), Stream$StreamCanBuildFrom_0);
...
defineSeed(1126, 1, makeCastMap([Q$ScalaObject]), Stream$cons$_0);
var MODULE$_40;
function $$init_878(){
}
...
defineSeed(1127, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), StreamIterator_0);
...
defineSeed(1128, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$2_0);
...
defineSeed(1129, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$next$1_0);
...
defineSeed(1130, 912, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$toStream$1_0);
_.apply_3 = function apply_196(){
  return $apply_125();
}
;
function $$init_882(this$static){
}
...
defineSeed(1131, 1, makeCastMap([Q$ScalaObject]), StreamIterator$LazyCell_0);
_.bitmap$0 = 0;
_.st = null;
_.v$u0020 = null;
...
defineSeed(1147, 1146, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0, Q$ArrayBuilder$ofInt, Q$Builder]), ArrayBuilder$ofInt_0);
...
defineSeed(1151, 1150, makeCastMap([Q$Equals, Q$ScalaObject, Q$GenIterableLike, Q$GenTraversableLike, Q$GenTraversableOnce, Q$IndexedSeqLike, Q$IterableLike, Q$TraversableLike, Q$TraversableOnce, Q$FilterMonadic, Q$HasNewBuilder, Q$IndexedSeqLike_0]), ArrayOps$ofInt_0);
...
defineSeed(1174, 1, makeCastMap([Q$ScalaObject]), IndexedSeqView$_0);
var MODULE$_48;
function $$init_911(this$static){
}
...
defineSeed(1178, 1, {}, IndexedSeqView$$anon$7_0);
...
;
var Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$1', 378, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$3', 381, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$1', 385, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$5_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$5', 382, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqView$_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$', 1174, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$2', 386, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$7_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$7', 383, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$3', 387, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$9_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$9', 384, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$4_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$4', 388, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_MenuItemSeparator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MenuItemSeparator', 683, Lcom_google_gwt_user_client_ui_UIObject_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$11_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$11', 379, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$5_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$5', 389, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$7_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$7', 1178, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqLike$$anon$1_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqLike$$anon$1', 1172, Ljava_lang_Object_2_classLit), Lscala_collection_TraversableView$NoBuilder_2_classLit = createForClass('scala.collection.', 'TraversableView$NoBuilder', 1018, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$', 1109, Lscala_collection_generic_SeqFactory_2_classLit), Lscala_collection_immutable_Stream_2_classLit = createForClass('scala.collection.immutable.', 'Stream', 1108, Ljava_lang_Object_2_classLit), Lscala_collection_generic_SliceInterval$_2_classLit = createForClass('scala.collection.generic.', 'SliceInterval$', 1040, Ljava_lang_Object_2_classLit), Lscala_collection_generic_SliceInterval_2_classLit = createForClass('scala.collection.generic.', 'SliceInterval', 1039, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$cons$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$cons$', 1126, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$$anonfun$from$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$from$1', 1115, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$Cons_2_classLit = createForClass('scala.collection.immutable.', 'Stream$Cons', 1119, Lscala_collection_immutable_Stream_2_classLit), Lscala_collection_SeqViewLike$$anon$9_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$9', 999, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$StreamCanBuildFrom_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamCanBuildFrom', 1125, Lscala_collection_generic_GenTraversableFactory$GenericCanBuildFrom_2_classLit), Lscala_collection_mutable_LazyBuilder_2_classLit = createForClass('scala.collection.mutable.', 'LazyBuilder', 1123, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$StreamBuilder_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamBuilder', 1122, Lscala_collection_mutable_LazyBuilder_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$2_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$2', 1176, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$1_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$1', 1175, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$Empty$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$Empty$', 1121, Lscala_collection_immutable_Stream_2_classLit), Lscala_collection_immutable_StreamIterator_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator', 1127, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_List$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.immutable.', 'List$$anonfun$toStream$1', 1070, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$StreamBuilder$$anonfun$result$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamBuilder$$anonfun$result$1', 1124, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_immutable_StreamIterator$LazyCell_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$LazyCell', 1131, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$2_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$2', 1128, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$take$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$take$1', 1116, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$take$2_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$take$2', 1117, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_Iterator$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.', 'Iterator$$anonfun$toStream$1', 964, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$flatMap$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$flatMap$1', 1114, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$next$1_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$next$1', 1129, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$toStream$1', 1130, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$filteredTail$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$filteredTail$1', 1113, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_Iterator$$anon$5_2_classLit = createForClass('scala.collection.', 'Iterator$$anon$5', 963, Ljava_lang_Object_2_classLit), Lscala_collection_TraversableLike$$anonfun$flatMap$1_2_classLit = createForClass('scala.collection.', 'TraversableLike$$anonfun$flatMap$1', 1011, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_immutable_Stream$$anonfun$append$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$append$1', 1112, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_GenSeqViewLike$Filtered$$anonfun$index$2_2_classLit = createForClass('scala.collection.', 'GenSeqViewLike$Filtered$$anonfun$index$2', 924, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lscala_collection_mutable_ArrayOps$ofInt_2_classLit = createForClass('scala.collection.mutable.', 'ArrayOps$ofInt', 1151, Lscala_collection_mutable_ArrayOps_2_classLit), Lscala_collection_SeqViewLike$$anon$6_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$6', 998, Ljava_lang_Object_2_classLit), Lscala_collection_SeqViewLike$$anon$5_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$5', 997, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_ArrayBuilder$ofInt_2_classLit = createForClass('scala.collection.mutable.', 'ArrayBuilder$ofInt', 1147, Lscala_collection_mutable_ArrayBuilder_2_classLit), Lscala_collection_Iterator$$anon$22_2_classLit = createForClass('scala.collection.', 'Iterator$$anon$22', 961, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$ConsWrapper_2_classLit = createForClass('scala.collection.immutable.', 'Stream$ConsWrapper', 1120, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$$anonfun$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$1', 1111, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$5_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$5', 1177, Ljava_lang_Object_2_classLit), Lscala_collection_SeqViewLike$$anon$11_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$11', 995, Ljava_lang_Object_2_classLit), Lscala_collection_GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1_2_classLit = createForClass('scala.collection.', 'GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1', 926, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(10);
