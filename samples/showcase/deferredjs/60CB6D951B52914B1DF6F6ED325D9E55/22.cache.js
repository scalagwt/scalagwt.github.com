...
defineSeed(447, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(448, 1, {}, CwDisclosurePanel$$anon$2_0);
...
defineSeed(449, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwDisclosurePanel$$anonfun$createAdvancedForm$1_0);
...
function $clinit_DisclosurePanel(){
  ...
  $clinit_UIObject();
  DEFAULT_IMAGES = new DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator_0;
  350;
  'gwt-DisclosurePanel';
  'open';
  'closed';
...
defineSeed(626, 241, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsRenderable, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), DisclosurePanel_2);
...
defineSeed(627, 258, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$AcceptsOneWidget, Q$HasOneWidget, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$SimplePanel, Q$UIObject, Q$Widget, Q$Iterable]), DisclosurePanel$ClickableHeader_0);
...
defineSeed(628, 3, {}, DisclosurePanel$ContentAnimation_0);
...
defineSeed(629, 242, makeCastMap([Q$CloseHandler, Q$HasAttachHandlers, Q$OpenHandler, Q$EventHandler, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), DisclosurePanel$DefaultHeader_0);
...
defineSeed(630, 1, {}, DisclosurePanel$DefaultHeader$2_0);
...
function $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator(){
  $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator = nullMethod;
  _instance0_4 = new DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator_0;
...
function DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator_0(){
  $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator();
  Object_1.call(this);
  $$init_495();
}

defineSeed(631, 1, {}, DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator_0);
...
function $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator$disclosurePanelClosedInitializer(){
  $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator$disclosurePanelClosedInitializer = nullMethod;
  $disclosurePanelClosedInitializer(($clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator() , _instance0_4));
}

function get_55(){
  $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator$disclosurePanelClosedInitializer();
  return $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator() , disclosurePanelClosed;
}

function $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator$disclosurePanelOpenInitializer(){
  $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator$disclosurePanelOpenInitializer = nullMethod;
  $disclosurePanelOpenInitializer(($clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator() , _instance0_4));
}

function get_56(){
  $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator$disclosurePanelOpenInitializer();
  return $clinit_DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator() , disclosurePanelOpen;
}
...
;
var Lcom_google_gwt_user_client_ui_DisclosurePanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel', 626, Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$ClickableHeader_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$ClickableHeader', 627, Lcom_google_gwt_user_client_ui_SimplePanel_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$ContentAnimation_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$ContentAnimation', 628, Lcom_google_gwt_animation_client_Animation_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$DefaultHeader_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$DefaultHeader', 629, Lcom_google_gwt_user_client_ui_Widget_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$DefaultHeader$2_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$DefaultHeader$2', 630, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwDisclosurePanel$$anon$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwDisclosurePanel$$anon$2', 448, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwDisclosurePanel$$anonfun$createAdvancedForm$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwDisclosurePanel$$anonfun$createAdvancedForm$1', 449, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel_1DefaultImages_1default_1StaticClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel_DefaultImages_default_StaticClientBundleGenerator', 631, Ljava_lang_Object_2_classLit);
$entry(onLoad)(22);
