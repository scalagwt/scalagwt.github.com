...
defineSeed(331, 1, {}, ColorConstants__0);
...
function $com$google$gwt$sample$showcase$client$content$i18n$CwConstantsWithLookupExample$$updateColor(this$static){
  ...
  if ($equals_3(key, '')) {
    $setText_8($colorResultsBox(this$static), this$static.constants.cwConstantsWithLookupExampleNoInput());
  }
   else {
    try {
      color = $colorConstants(this$static).getString(key);
      $setText_8($colorResultsBox(this$static), color);
    }
     catch ($e0) {
      $e0 = caught_0($e0);
      if (instanceOf($e0, Q$MissingResourceException)) {
        $e0;
        $setText_8($colorResultsBox(this$static), this$static.constants.cwConstantsWithLookupExampleNoMatches());
      }
       else 
        throw $e0;
    }
...
function $onInitialize_0(this$static){
  ...
  $setText_8($colorBox(this$static), 'red');
...
defineSeed(338, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CwConstantsWithLookupExample$$anon$1_0);
...
defineSeed(339, 1, makeCastMap([Q$KeyUpHandler, Q$EventHandler]), CwConstantsWithLookupExample$$anon$2_0);
...
;
_.$outer$u0020 = null;
defineSeed(340, 1, makeCastMap([Q$RunAsyncCallback]));
_.onSuccess = function onSuccess_1(){
  this.callback$1.onSuccess_0($onInitialize_0(this.$outer$u0020));
}
;
var Lcom_google_gwt_sample_showcase_client_content_i18n_ColorConstants_1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'ColorConstants_', 331, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsWithLookupExample$$anon$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsWithLookupExample$$anon$1', 338, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsWithLookupExample$$anon$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsWithLookupExample$$anon$2', 339, Ljava_lang_Object_2_classLit);
$entry(onLoad)(33);
