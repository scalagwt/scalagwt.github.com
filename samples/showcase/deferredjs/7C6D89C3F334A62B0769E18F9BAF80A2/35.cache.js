...
function $createOptionsBar(this$static){
  ...
  $onClick(($clinit_Handlers$() , MODULE$_2).enrichHasClickHandlers($com$google$gwt$sample$showcase$client$content$other$CwAnimation$$startButton(this$static)), new CwAnimation$$anonfun$createOptionsBar$1_0(this$static));
  ...
  $onClick(($clinit_Handlers$() , MODULE$_2).enrichHasClickHandlers($com$google$gwt$sample$showcase$client$content$other$CwAnimation$$cancelButton(this$static)), new CwAnimation$$anonfun$createOptionsBar$2_0(this$static));
...
_ = CwAnimation$$anon$1.prototype;
...
function CwAnimation$$anonfun$createOptionsBar$1(){
}

_ = CwAnimation$$anonfun$createOptionsBar$1_0.prototype = CwAnimation$$anonfun$createOptionsBar$1.prototype = new AbstractFunction1;
_.apply_0 = function apply_40(v1){
  $apply_39(this, dynamicCast(v1, Q$ClickEvent));
  return $clinit_BoxedUnit() , UNIT;
}
;
_.getClass$ = function getClass_390(){
  return Lcom_google_gwt_sample_showcase_client_content_other_CwAnimation$$anonfun$createOptionsBar$1_2_classLit;
}
;
...
function CwAnimation$$anonfun$createOptionsBar$2(){
}

_ = CwAnimation$$anonfun$createOptionsBar$2_0.prototype = CwAnimation$$anonfun$createOptionsBar$2.prototype = new AbstractFunction1;
_.apply_0 = function apply_41(v1){
  $apply_40(this, dynamicCast(v1, Q$ClickEvent));
  return $clinit_BoxedUnit() , UNIT;
}
;
_.getClass$ = function getClass_391(){
  return Lcom_google_gwt_sample_showcase_client_content_other_CwAnimation$$anonfun$createOptionsBar$2_2_classLit;
}
;
_.castableTypeMap$ = makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]);
_.$outer$u0020 = null;
...
function $updatePosition(this$static, w, _radian, offset){
  ...
  x = $radius(this$static) * cos(radian) + $centerX(this$static);
  y = $radius(this$static) * sin(radian) + $centerY(this$static);
...
function CwAnimation$CustomAnimation(){
}

_ = CwAnimation$CustomAnimation_0.prototype = CwAnimation$CustomAnimation.prototype = new Animation;
_.getClass$ = function getClass_392(){
  return Lcom_google_gwt_sample_showcase_client_content_other_CwAnimation$CustomAnimation_2_classLit;
}
;
...
var Lcom_google_gwt_sample_showcase_client_content_other_CwAnimation$CustomAnimation_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwAnimation$CustomAnimation', 'CwAnimation$CustomAnimation', Lcom_google_gwt_animation_client_Animation_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwAnimation$$anonfun$createOptionsBar$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwAnimation$$anonfun$createOptionsBar$1', 'CwAnimation$$anonfun$createOptionsBar$1', Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwAnimation$$anonfun$createOptionsBar$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwAnimation$$anonfun$createOptionsBar$2', 'CwAnimation$$anonfun$createOptionsBar$2', Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(35);
