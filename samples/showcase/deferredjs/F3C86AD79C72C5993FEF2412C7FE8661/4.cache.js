...
defineSeed(251, 1, makeCastMap([Q$ScalaObject]), ClickHandlers$_0);
...
defineSeed(527, 267, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwFileUpload$$anonfun$onInitialize$1_0);
...
defineSeed(630, 241, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), FileUpload_0);
...
defineSeed(631, 1, {}, FileUpload$FileUploadImpl_0);
...
;
var Lcom_google_gwt_user_client_ui_FileUpload_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload', 630, Lcom_google_gwt_user_client_ui_Widget_2_classLit), Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImpl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload$FileUploadImpl', 631, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_ClickHandlers$_2_classLit = createForClass('com.google.gwt.sample.showcase.client.', 'ClickHandlers$', 251, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_widgets_CwFileUpload$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.widgets.', 'CwFileUpload$$anonfun$onInitialize$1', 527, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(4);
