...
function $clinit_ShowcaseImages_default_InlineClientBundleGenerator$jimmyThumbInitializer(){
  $clinit_ShowcaseImages_default_InlineClientBundleGenerator$jimmyThumbInitializer = nullMethod;
  $jimmyThumbInitializer(($clinit_ShowcaseImages_default_InlineClientBundleGenerator() , _instance0_0));
}

function get_21(){
  $clinit_ShowcaseImages_default_InlineClientBundleGenerator$jimmyThumbInitializer();
  return $clinit_ShowcaseImages_default_InlineClientBundleGenerator() , jimmyThumb_0;
}
...
defineSeed(470, 267, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwBasicPopup$$anonfun$1_0);
...
defineSeed(471, 267, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwBasicPopup$$anonfun$onInitialize$1_0);
...
defineSeed(472, 267, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwBasicPopup$$anonfun$onInitialize$2_0);
...
defineSeed(601, 602, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$AcceptsOneWidget, Q$HasOneWidget, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$PopupPanel, Q$SimplePanel, Q$UIObject, Q$Widget, Q$Iterable]), DecoratedPopupPanel_0);
var Lcom_google_gwt_sample_showcase_client_content_popups_CwBasicPopup$$anonfun$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.popups.', 'CwBasicPopup$$anonfun$1', 470, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_popups_CwBasicPopup$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.popups.', 'CwBasicPopup$$anonfun$onInitialize$1', 471, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_popups_CwBasicPopup$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.popups.', 'CwBasicPopup$$anonfun$onInitialize$2', 472, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(14);
