...
defineSeed(469, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(470, 445, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwVerticalSplitPanel$$anonfun$onInitialize$1_0);
...
defineSeed(744, 651, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]), VerticalSplitPanel_0);
...
defineSeed(745, 1, makeCastMap([Q$Command]), VerticalSplitPanel$1_0);
...
defineSeed(746, 1, {}, VerticalSplitPanel$Impl_0);
...
function $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator(){
  ...
  _instance0_7 = new VerticalSplitPanel_Resources_default_InlineClientBundleGenerator_0;
...
defineSeed(747, 1, {}, VerticalSplitPanel_Resources_default_InlineClientBundleGenerator_0);
...
function $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator$verticalSplitPanelThumbInitializer(){
  ...
  $verticalSplitPanelThumbInitializer(($clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator() , _instance0_7));
}
...
var Lcom_google_gwt_user_client_ui_VerticalSplitPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel', 744, Lcom_google_gwt_user_client_ui_SplitPanel_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel$Impl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel$Impl', 746, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel$1', 745, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwVerticalSplitPanel$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwVerticalSplitPanel$$anonfun$onInitialize$1', 470, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel_1Resources_1default_1InlineClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel_Resources_default_InlineClientBundleGenerator', 747, Ljava_lang_Object_2_classLit);
$entry(onLoad)(25);
