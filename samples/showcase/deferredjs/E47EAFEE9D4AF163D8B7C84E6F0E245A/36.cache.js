...
function $com$google$gwt$sample$showcase$client$content$other$CwCookies$$updateExstingCookie(this$static){
  ...
  if ($getItemCount($com$google$gwt$sample$showcase$client$content$other$CwCookies$$existingCookiesBox(this$static)) < 1) {
    $setText_7($com$google$gwt$sample$showcase$client$content$other$CwCookies$$cookieNameBox(this$static), '');
    $setText_7($com$google$gwt$sample$showcase$client$content$other$CwCookies$$cookieValueBox(this$static), '');
  }
   else {
    ...
    $setText_7($com$google$gwt$sample$showcase$client$content$other$CwCookies$$cookieNameBox(this$static), cookieName);
    $setText_7($com$google$gwt$sample$showcase$client$content$other$CwCookies$$cookieValueBox(this$static), cookieValue);
  }
}
...
defineSeed(432, 1, makeCastMap([Q$Command]), CwCookies$$anon$1_0);
...
defineSeed(434, 270, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$com$google$gwt$sample$showcase$client$content$other$CwCookies$$refreshExistingCookies$1_0);
...
defineSeed(435, 270, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$onInitialize$1_0);
...
defineSeed(436, 270, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$onInitialize$2_0);
...
defineSeed(437, 270, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$onInitialize$3_0);
...
defineSeed(850, 1, makeCastMap([Q$Iterable, Q$Collection]));
...
defineSeed(936, 937, makeCastMap([Q$ScalaObject]), Iterable$_0);
...
var Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$onInitialize$1', 435, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$onInitialize$2', 436, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$onInitialize$3', 437, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$com$google$gwt$sample$showcase$client$content$other$CwCookies$$refreshExistingCookies$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$com$google$gwt$sample$showcase$client$content$other$CwCookies$$refreshExistingCookies$1', 434, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anon$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anon$1', 432, Ljava_lang_Object_2_classLit), Lscala_collection_JavaConversions$JCollectionWrapper_2_classLit = createForClass('scala.collection.', 'JavaConversions$JCollectionWrapper', 955, Ljava_lang_Object_2_classLit), Lscala_collection_Iterable$_2_classLit = createForClass('scala.collection.', 'Iterable$', 936, Lscala_collection_generic_GenTraversableFactory_2_classLit);
$entry(onLoad)(36);
