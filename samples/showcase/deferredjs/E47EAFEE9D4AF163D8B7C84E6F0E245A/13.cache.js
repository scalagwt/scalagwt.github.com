...
defineSeed(137, 104, {}, InitializeEvent_0);
...
;
defineSeed(261, 244, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]));
_.add_1 = function add_2(child){
  throw new UnsupportedOperationException_1('This panel does not support no-arg add()');
}
;
defineSeed(260, 261, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$AcceptsOneWidget, Q$HasOneWidget, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$SimplePanel, Q$UIObject, Q$Widget, Q$Iterable]));
...
defineSeed(494, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(495, 243, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsRenderable, Q$IsWidget, Q$UIObject, Q$Widget, Q$ScalaObject]), RichTextToolbar_0);
...
defineSeed(496, 1, makeCastMap([Q$ScalaObject]), RichTextToolbar$_0);
...
defineSeed(497, 1, makeCastMap([Q$ChangeHandler, Q$ClickHandler, Q$KeyUpHandler, Q$EventHandler, Q$ScalaObject]), RichTextToolbar$EventHandler_0);
...
defineSeed(498, 1, {}, RichTextToolbar_Images_default_InlineClientBundleGenerator_0);
...
defineSeed(517, 1, {}, RichTextToolbar_Strings__0);
...
defineSeed(590, 591, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]));
_.add_1 = function add_4(w){
  $add_4(this, w);
}
;
defineSeed(606, 260, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$AcceptsOneWidget, Q$HasOneWidget, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$PopupPanel, Q$SimplePanel, Q$UIObject, Q$Widget, Q$Iterable]));
...
;
defineSeed(640, 591, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]));
_.add_1 = function add_7(w){
  $add_10(this, w);
}
;
defineSeed(649, 598, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]));
...
function $$init_559(this$static){
  this$static.impl = new RichTextAreaImplSafari_0;
}
...
defineSeed(699, 308, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), RichTextArea_0);
...
defineSeed(700, 1, makeCastMap([Q$RichTextArea$FontSize]), RichTextArea$FontSize_0);
...
defineSeed(701, 1, {}, RichTextArea$Justification_0);
...
defineSeed(743, 598, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]));
...
defineSeed(763, 764, makeCastMap([Q$RichTextArea$Formatter]), RichTextAreaImplSafari_0);
_.getTextImpl = function getTextImpl_0(){
  return this.elem.contentWindow.document.body.innerText;
}
;
...
;
var Lcom_google_gwt_user_client_ui_RichTextArea_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'RichTextArea', 699, Lcom_google_gwt_user_client_ui_FocusWidget_2_classLit), Lcom_google_gwt_user_client_ui_RichTextArea$FontSize_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'RichTextArea$FontSize', 700, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_RichTextArea$Justification_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'RichTextArea$Justification', 701, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_text_RichTextToolbar_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.text.', 'RichTextToolbar', 495, Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_impl_RichTextAreaImpl_2_classLit = createForClass('com.google.gwt.user.client.ui.impl.', 'RichTextAreaImpl', 762, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_text_RichTextToolbar_1Images_1default_1InlineClientBundleGenerator_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.text.', 'RichTextToolbar_Images_default_InlineClientBundleGenerator', 498, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_text_RichTextToolbar_1Strings_1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.text.', 'RichTextToolbar_Strings_', 517, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_text_RichTextToolbar$EventHandler_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.text.', 'RichTextToolbar$EventHandler', 497, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_impl_RichTextAreaImplStandard_2_classLit = createForClass('com.google.gwt.user.client.ui.impl.', 'RichTextAreaImplStandard', 764, Lcom_google_gwt_user_client_ui_impl_RichTextAreaImpl_2_classLit), Lcom_google_gwt_user_client_ui_impl_RichTextAreaImplSafari_2_classLit = createForClass('com.google.gwt.user.client.ui.impl.', 'RichTextAreaImplSafari', 763, Lcom_google_gwt_user_client_ui_impl_RichTextAreaImplStandard_2_classLit), Lcom_google_gwt_sample_showcase_client_content_text_RichTextToolbar$_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.text.', 'RichTextToolbar$', 496, Ljava_lang_Object_2_classLit), _3Lcom_google_gwt_user_client_ui_RichTextArea$FontSize_2_classLit = createForArray('[Lcom.google.gwt.user.client.ui.', 'RichTextArea$FontSize;', 1343, Lcom_google_gwt_user_client_ui_RichTextArea$FontSize_2_classLit), Lcom_google_gwt_event_logical_shared_InitializeEvent_2_classLit = createForClass('com.google.gwt.event.logical.shared.', 'InitializeEvent', 137, Lcom_google_gwt_event_shared_GwtEvent_2_classLit);
$entry(onLoad)(13);
