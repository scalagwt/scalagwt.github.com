...
;
_.castableTypeMap$ = makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsRenderable, Q$IsWidget, Q$SourcesTabEvents, Q$TabListener, Q$UIObject, Q$Widget, Q$Iterable]);
function $$init_461(){
}
...
;
_.castableTypeMap$ = makeCastMap([Q$BeforeSelectionHandler, Q$SelectionHandler, Q$EventHandler]);
function $$init_565(){
}
...
;
_.castableTypeMap$ = makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsRenderable, Q$IsWidget, Q$SourcesTabEvents, Q$TabBar, Q$UIObject, Q$Widget]);
_.this$0 = null;
var Lcom_google_gwt_user_client_ui_TabPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'TabPanel', 'TabPanel', Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_DecoratedTabPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DecoratedTabPanel', 'DecoratedTabPanel', Lcom_google_gwt_user_client_ui_TabPanel_2_classLit), Lcom_google_gwt_user_client_ui_TabPanel$TabbedDeckPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'TabPanel$TabbedDeckPanel', 'TabPanel$TabbedDeckPanel', Lcom_google_gwt_user_client_ui_DeckPanel_2_classLit), Lcom_google_gwt_user_client_ui_TabPanel$UnmodifiableTabBar_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'TabPanel$UnmodifiableTabBar', 'TabPanel$UnmodifiableTabBar', Lcom_google_gwt_user_client_ui_TabBar_2_classLit), Lcom_google_gwt_user_client_ui_ListenerWrapper$WrappedTabListener_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'ListenerWrapper$WrappedTabListener', 'ListenerWrapper$WrappedTabListener', Lcom_google_gwt_user_client_ui_ListenerWrapper_2_classLit);
$entry(onLoad)(23);
