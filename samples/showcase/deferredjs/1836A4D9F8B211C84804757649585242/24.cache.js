...
function $getEndOfLinePos(){
  return $isRTL(getCurrentLocale())?0:1;
}
...
function $getStartOfLinePos(){
  return $isRTL(getCurrentLocale())?1:0;
}
...
defineSeed(729, 730, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]), HorizontalSplitPanel_0);
...
defineSeed(731, 1, makeCastMap([Q$Command]), HorizontalSplitPanel$1_0);
...
function $init_1(this$static, panel){
  ...
  $isRTL(getCurrentLocale())?setLeft($getElement_1(panel, 0), '0px'):setRight($getElement_1(panel, 1), '0px');
}
...
defineSeed(732, 1, {}, HorizontalSplitPanel$Impl_0);
...
defineSeed(733, 1, {}, HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator_0);
...
var Lcom_google_gwt_user_client_ui_HorizontalSplitPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel', 729, Lcom_google_gwt_user_client_ui_SplitPanel_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel$Impl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel$Impl', 732, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel$1', 731, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwHorizontalSplitPanel$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwHorizontalSplitPanel$$anonfun$onInitialize$1', 542, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel_1Resources_1en_1InlineClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator', 733, Ljava_lang_Object_2_classLit);
$entry(onLoad)(24);
