...
function $realizeTable(this$static){
  ...
  for (it = $iterator_2($getChildren(this$static)); it.hasNext();) {
    ...
    dir = dynamicCast($getLayoutData(child), Q$DockPanel$LayoutData).direction;
  ...
  for (it = $iterator_2($getChildren(this$static)); it.hasNext();) {
    ...
    if (jsEquals(layout.direction, NORTH)) {
     ...
     else if (jsEquals(layout.direction, SOUTH)) {
      insertChild(rows[southRow].tr, td, rows[southRow].center);
      appendChild(td, $getElement(child));
      setElementPropertyInt(td, 'colSpan', logicalRightCol - logicalLeftCol + 1);
      --southRow;
    }
     else if (jsEquals(layout.direction, CENTER)) {
      centerTd = td;
    }
...
defineSeed(708, 676, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]), DockPanel_0);
...
_.setCellHeight = function setCellHeight_0(w, height){
  ...
  data = dynamicCast($getLayoutData(w), Q$DockPanel$LayoutData);
  data.height = height;
  isNotNull(data.td) && setStyleAttribute(data.td, 'height', data.height);
}
;
...
_.setCellWidth = function setCellWidth_0(w, width){
  ...
  data = dynamicCast($getLayoutData(w), Q$DockPanel$LayoutData);
  data.width = width;
  isNotNull(data.td) && setStyleAttribute(data.td, 'width', data.width);
}
;
_.center = null;
...
defineSeed(709, 1, {}, DockPanel$DockLayoutConstant_0);
...
defineSeed(710, 1, makeCastMap([Q$DockPanel$LayoutData]), DockPanel$LayoutData_0);
_.direction = null;
_.height = '';
_.td = null;
_.width = '';
...
defineSeed(711, 1, makeCastMap([Q$DockPanel$TmpRow]), DockPanel$TmpRow_0);
_.center = 0;
_.tr = null;
var Lcom_google_gwt_user_client_ui_DockPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DockPanel', 708, Lcom_google_gwt_user_client_ui_CellPanel_2_classLit), Lcom_google_gwt_user_client_ui_DockPanel$TmpRow_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DockPanel$TmpRow', 711, Ljava_lang_Object_2_classLit), _3Lcom_google_gwt_user_client_ui_DockPanel$TmpRow_2_classLit = createForArray('[Lcom.google.gwt.user.client.ui.', 'DockPanel$TmpRow;', 1416, Lcom_google_gwt_user_client_ui_DockPanel$TmpRow_2_classLit), Lcom_google_gwt_user_client_ui_DockPanel$DockLayoutConstant_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DockPanel$DockLayoutConstant', 709, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_DockPanel$LayoutData_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DockPanel$LayoutData', 710, Ljava_lang_Object_2_classLit);
$entry(onLoad)(21);
