...
defineSeed(334, 1, makeCastMap([Q$ScalaObject]), ClickHandlers$_0);
...
defineSeed(609, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(610, 350, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwFileUpload$$anonfun$onInitialize$1_0);
...
defineSeed(712, 324, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), FileUpload_0);
...
defineSeed(714, 713, {}, FileUpload$FileUploadImplOpera_0);
...
_.fileUpload = null;
var Lcom_google_gwt_user_client_ui_FileUpload_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload', 712, Lcom_google_gwt_user_client_ui_Widget_2_classLit), Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImpl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload$FileUploadImpl', 713, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImplOpera_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload$FileUploadImplOpera', 714, Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImpl_2_classLit), Lcom_google_gwt_sample_showcase_client_ClickHandlers$_2_classLit = createForClass('com.google.gwt.sample.showcase.client.', 'ClickHandlers$', 334, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_widgets_CwFileUpload$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.widgets.', 'CwFileUpload$$anonfun$onInitialize$1', 610, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(4);
