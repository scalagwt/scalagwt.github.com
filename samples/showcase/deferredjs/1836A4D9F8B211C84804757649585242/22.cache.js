...
defineSeed(529, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(530, 1, {}, CwDisclosurePanel$$anon$2_0);
...
defineSeed(531, 350, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwDisclosurePanel$$anonfun$createAdvancedForm$1_0);
...
function $clinit_DisclosurePanel(){
  ...
  $clinit_UIObject();
  DEFAULT_IMAGES = new DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator_0;
  350;
  'gwt-DisclosurePanel';
  'open';
  'closed';
...
defineSeed(700, 323, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsRenderable, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), DisclosurePanel_2);
...
defineSeed(701, 340, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$AcceptsOneWidget, Q$HasOneWidget, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$SimplePanel, Q$UIObject, Q$Widget, Q$Iterable]), DisclosurePanel$ClickableHeader_0);
...
defineSeed(702, 3, {}, DisclosurePanel$ContentAnimation_0);
...
defineSeed(703, 324, makeCastMap([Q$CloseHandler, Q$HasAttachHandlers, Q$OpenHandler, Q$EventHandler, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), DisclosurePanel$DefaultHeader_0);
...
defineSeed(704, 1, {}, DisclosurePanel$DefaultHeader$2_0);
...
function $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator(){
  $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator = nullMethod;
  _instance0_3 = new DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator_0;
...
function $disclosurePanelClosedInitializer(){
  disclosurePanelClosed = new ImageResourcePrototype_0('disclosurePanelClosed', fromTrustedString_0($isRTL(getCurrentLocale())?'data:image/png;base64,':'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAfklEQVR42mNgoDZITk4WosiAtLS0M6mpqb1Amp9cAy4B8X8gfpWenp5MiQEwfB6IbSgxAIaXArEcJQaA8Ddg+NQVFhZykmsADG8MDQ1lJseA5wQDFocBP0FRm5WVxUNOGGwEJi4VcmLhKtC5HuSkg8NA5+bjDCRCAG8UDUoAAIw8kVdwMG+3AAAAAElFTkSuQmCC'), 0, 0, 16, 16, false, false);
}
...
function DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator_0(){
  $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator();
  Object_1.call(this);
  $$init_574();
}

defineSeed(705, 1, {}, DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator_0);
...
function $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator$disclosurePanelClosedInitializer(){
  $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator$disclosurePanelClosedInitializer = nullMethod;
  $disclosurePanelClosedInitializer(($clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator() , _instance0_3));
}

function get_53(){
  $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator$disclosurePanelClosedInitializer();
  return $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator() , disclosurePanelClosed;
}

function $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator$disclosurePanelOpenInitializer(){
  $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator$disclosurePanelOpenInitializer = nullMethod;
  $disclosurePanelOpenInitializer(($clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator() , _instance0_3));
}

function get_54(){
  $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator$disclosurePanelOpenInitializer();
  return $clinit_DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator() , disclosurePanelOpen;
}
...
_.setUrlAndVisibleRect = function setUrlAndVisibleRect(image, url, left, top_0, width, height){
  if (!this.url.equals$(url) || this.left != left || this.top_0 != top_0 || this.width != width || this.height != height) {
    this.url = url;
    this.left = left;
    this.top_0 = top_0;
    this.width = width;
...
;
var Lcom_google_gwt_user_client_ui_DisclosurePanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel', 700, Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$ClickableHeader_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$ClickableHeader', 701, Lcom_google_gwt_user_client_ui_SimplePanel_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$ContentAnimation_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$ContentAnimation', 702, Lcom_google_gwt_animation_client_Animation_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$DefaultHeader_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$DefaultHeader', 703, Lcom_google_gwt_user_client_ui_Widget_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$DefaultHeader$2_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$DefaultHeader$2', 704, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwDisclosurePanel$$anon$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwDisclosurePanel$$anon$2', 530, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwDisclosurePanel$$anonfun$createAdvancedForm$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwDisclosurePanel$$anonfun$createAdvancedForm$1', 531, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel_1DefaultImages_1en_1InlineClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel_DefaultImages_en_InlineClientBundleGenerator', 705, Ljava_lang_Object_2_classLit);
$entry(onLoad)(22);
