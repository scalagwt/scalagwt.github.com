...
defineSeed(428, 1, makeCastMap([Q$Command]), CwCookies$$anon$1_0);
...
defineSeed(430, 266, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$com$google$gwt$sample$showcase$client$content$other$CwCookies$$refreshExistingCookies$1_0);
...
defineSeed(431, 266, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$onInitialize$1_0);
...
defineSeed(432, 266, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$onInitialize$2_0);
...
defineSeed(433, 266, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwCookies$$anonfun$onInitialize$3_0);
...
defineSeed(842, 1, makeCastMap([Q$Iterable, Q$Collection]));
...
defineSeed(928, 929, makeCastMap([Q$ScalaObject]), Iterable$_0);
...
var Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$onInitialize$1', 431, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$onInitialize$2', 432, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$onInitialize$3', 433, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anonfun$com$google$gwt$sample$showcase$client$content$other$CwCookies$$refreshExistingCookies$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anonfun$com$google$gwt$sample$showcase$client$content$other$CwCookies$$refreshExistingCookies$1', 430, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_other_CwCookies$$anon$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.other.', 'CwCookies$$anon$1', 428, Ljava_lang_Object_2_classLit), Lscala_collection_JavaConversions$JCollectionWrapper_2_classLit = createForClass('scala.collection.', 'JavaConversions$JCollectionWrapper', 947, Ljava_lang_Object_2_classLit), Lscala_collection_Iterable$_2_classLit = createForClass('scala.collection.', 'Iterable$', 928, Lscala_collection_generic_GenTraversableFactory_2_classLit);
$entry(onLoad)(36);
