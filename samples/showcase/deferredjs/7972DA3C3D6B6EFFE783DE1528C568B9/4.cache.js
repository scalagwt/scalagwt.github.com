...
defineSeed(250, 1, makeCastMap([Q$ScalaObject]), ClickHandlers$_0);
...
defineSeed(525, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(526, 266, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwFileUpload$$anonfun$onInitialize$1_0);
...
defineSeed(628, 240, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), FileUpload_0);
...
defineSeed(630, 629, {}, FileUpload$FileUploadImplOpera_0);
...
_.fileUpload = null;
var Lcom_google_gwt_user_client_ui_FileUpload_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload', 628, Lcom_google_gwt_user_client_ui_Widget_2_classLit), Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImpl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload$FileUploadImpl', 629, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImplOpera_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'FileUpload$FileUploadImplOpera', 630, Lcom_google_gwt_user_client_ui_FileUpload$FileUploadImpl_2_classLit), Lcom_google_gwt_sample_showcase_client_ClickHandlers$_2_classLit = createForClass('com.google.gwt.sample.showcase.client.', 'ClickHandlers$', 250, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_widgets_CwFileUpload$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.widgets.', 'CwFileUpload$$anonfun$onInitialize$1', 526, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(4);
