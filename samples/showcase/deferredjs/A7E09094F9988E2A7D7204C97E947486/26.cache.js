...
defineSeed(482, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(483, 441, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwGrid$$anonfun$onInitialize$1_0);
...
defineSeed(484, 441, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwGrid$$anonfun$onInitialize$1$$anonfun$apply$mcVI$sp$1_0);
...
var Lcom_google_gwt_sample_showcase_client_content_tables_CwGrid$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.tables.', 'CwGrid$$anonfun$onInitialize$1', 483, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lcom_google_gwt_sample_showcase_client_content_tables_CwGrid$$anonfun$onInitialize$1$$anonfun$apply$mcVI$sp$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.tables.', 'CwGrid$$anonfun$onInitialize$1$$anonfun$apply$mcVI$sp$1', 484, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit);
$entry(onLoad)(26);
