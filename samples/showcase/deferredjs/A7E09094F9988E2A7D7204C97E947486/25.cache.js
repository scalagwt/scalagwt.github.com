...
defineSeed(465, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(466, 441, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwVerticalSplitPanel$$anonfun$onInitialize$1_0);
...
function VerticalSplitPanel_0(){
  VerticalSplitPanel_2.call(this, new VerticalSplitPanel_Resources_default_InlineClientBundleGenerator_0);
}
...
defineSeed(749, 652, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]), VerticalSplitPanel_0);
...
defineSeed(750, 1, makeCastMap([Q$Command]), VerticalSplitPanel$1_0);
...
defineSeed(752, 751, {}, VerticalSplitPanel$ImplIE6_0);
...
defineSeed(753, 10, makeCastMap([Q$Timer]), VerticalSplitPanel$ImplIE6$1_0);
...
;
_.this$1 = null;
function $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator(){
  $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator = nullMethod;
  _instance0_8 = new VerticalSplitPanel_Resources_default_InlineClientBundleGenerator_0;
...
function VerticalSplitPanel_Resources_default_InlineClientBundleGenerator_0(){
  $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator();
  Object_1.call(this);
  $$init_608();
}

defineSeed(754, 1, {}, VerticalSplitPanel_Resources_default_InlineClientBundleGenerator_0);
_.verticalSplitPanelThumb = function verticalSplitPanelThumb_0(){
  return get_66();
}
;
var _instance0_8, verticalSplitPanelThumb = null;
function $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator$verticalSplitPanelThumbInitializer(){
  $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator$verticalSplitPanelThumbInitializer = nullMethod;
  $verticalSplitPanelThumbInitializer(($clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator() , _instance0_8));
}

function get_66(){
  $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator$verticalSplitPanelThumbInitializer();
  return $clinit_VerticalSplitPanel_Resources_default_InlineClientBundleGenerator() , verticalSplitPanelThumb;
}

var Lcom_google_gwt_user_client_ui_VerticalSplitPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel', 749, Lcom_google_gwt_user_client_ui_SplitPanel_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel$Impl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel$Impl', 751, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel$ImplIE6_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel$ImplIE6', 752, Lcom_google_gwt_user_client_ui_VerticalSplitPanel$Impl_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel$ImplIE6$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel$ImplIE6$1', 753, Lcom_google_gwt_user_client_Timer_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel$1', 750, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwVerticalSplitPanel$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwVerticalSplitPanel$$anonfun$onInitialize$1', 466, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lcom_google_gwt_user_client_ui_VerticalSplitPanel_1Resources_1default_1InlineClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'VerticalSplitPanel_Resources_default_InlineClientBundleGenerator', 754, Ljava_lang_Object_2_classLit);
$entry(onLoad)(25);
