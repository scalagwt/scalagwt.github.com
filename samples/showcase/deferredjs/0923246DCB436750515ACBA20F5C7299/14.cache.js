...
function $clinit_ShowcaseImages_en_StaticClientBundleGenerator$jimmyThumbInitializer(){
  $clinit_ShowcaseImages_en_StaticClientBundleGenerator$jimmyThumbInitializer = nullMethod;
  $jimmyThumbInitializer(($clinit_ShowcaseImages_en_StaticClientBundleGenerator() , _instance0_0));
}

function get_21(){
  $clinit_ShowcaseImages_en_StaticClientBundleGenerator$jimmyThumbInitializer();
  return $clinit_ShowcaseImages_en_StaticClientBundleGenerator() , jimmyThumb_0;
}
