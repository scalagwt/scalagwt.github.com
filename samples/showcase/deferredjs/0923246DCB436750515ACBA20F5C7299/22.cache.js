...
defineSeed(531, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(532, 1, {}, CwDisclosurePanel$$anon$2_0);
...
defineSeed(533, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwDisclosurePanel$$anonfun$createAdvancedForm$1_0);
...
function $clinit_DisclosurePanel(){
  ...
  $clinit_UIObject();
  DEFAULT_IMAGES = new DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator_0;
  350;
  'gwt-DisclosurePanel';
  'open';
  'closed';
...
defineSeed(710, 325, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsRenderable, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), DisclosurePanel_2);
...
defineSeed(711, 342, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$AcceptsOneWidget, Q$HasOneWidget, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$SimplePanel, Q$UIObject, Q$Widget, Q$Iterable]), DisclosurePanel$ClickableHeader_0);
...
defineSeed(712, 3, {}, DisclosurePanel$ContentAnimation_0);
...
defineSeed(713, 326, makeCastMap([Q$CloseHandler, Q$HasAttachHandlers, Q$OpenHandler, Q$EventHandler, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), DisclosurePanel$DefaultHeader_0);
...
defineSeed(714, 1, {}, DisclosurePanel$DefaultHeader$2_0);
...
function $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator(){
  $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator = nullMethod;
  _instance0_4 = new DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator_0;
  bundledImage_None_3 = getModuleBaseURL() + 'E44767377485D18D6B6864F65BA8EF73.cache.png';
  bundledImage_None_rtl = getModuleBaseURL() + '0A9476898799A150D840F0B1C3672921.cache.png';
}
...
function $disclosurePanelClosedInitializer(){
  disclosurePanelClosed = new ImageResourcePrototype_0('disclosurePanelClosed', fromTrustedString_1($isRTL_0(getCurrentLocale())?bundledImage_None_rtl:bundledImage_None_3), 16, 0, 16, 16, false, false);
}

function $disclosurePanelOpenInitializer(){
  disclosurePanelOpen = new ImageResourcePrototype_0('disclosurePanelOpen', fromTrustedString_1($isRTL_0(getCurrentLocale())?bundledImage_None_rtl:bundledImage_None_3), 0, 0, 16, 16, false, false);
}

function DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator_0(){
  $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator();
  Object_1.call(this);
  $$init_579();
}

defineSeed(715, 1, {}, DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator_0);
...
;
var _instance0_4, bundledImage_None_3, bundledImage_None_rtl, disclosurePanelClosed = null, disclosurePanelOpen = null;
function $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator$disclosurePanelClosedInitializer(){
  $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator$disclosurePanelClosedInitializer = nullMethod;
  $disclosurePanelClosedInitializer(($clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator() , _instance0_4));
}

function get_55(){
  $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator$disclosurePanelClosedInitializer();
  return $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator() , disclosurePanelClosed;
}

function $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator$disclosurePanelOpenInitializer(){
  $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator$disclosurePanelOpenInitializer = nullMethod;
  $disclosurePanelOpenInitializer(($clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator() , _instance0_4));
}

function get_56(){
  $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator$disclosurePanelOpenInitializer();
  return $clinit_DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator() , disclosurePanelOpen;
}
...
;
var Lcom_google_gwt_user_client_ui_DisclosurePanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel', 710, Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$ClickableHeader_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$ClickableHeader', 711, Lcom_google_gwt_user_client_ui_SimplePanel_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$ContentAnimation_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$ContentAnimation', 712, Lcom_google_gwt_animation_client_Animation_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$DefaultHeader_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$DefaultHeader', 713, Lcom_google_gwt_user_client_ui_Widget_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel$DefaultHeader$2_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel$DefaultHeader$2', 714, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwDisclosurePanel$$anon$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwDisclosurePanel$$anon$2', 532, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwDisclosurePanel$$anonfun$createAdvancedForm$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwDisclosurePanel$$anonfun$createAdvancedForm$1', 533, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_DisclosurePanel_1DefaultImages_1en_1StaticClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'DisclosurePanel_DefaultImages_en_StaticClientBundleGenerator', 715, Ljava_lang_Object_2_classLit);
$entry(onLoad)(22);
