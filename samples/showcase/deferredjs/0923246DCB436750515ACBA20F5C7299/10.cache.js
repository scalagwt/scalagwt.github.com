...
defineSeed(462, 1, makeCastMap([Q$Command]), CwMenuBar$$anon$1_0);
...
defineSeed(463, 1, {}, CwMenuBar$$anon$11_0);
_.newInstance = function newInstance_5(len){
  return $newInstance_5(len);
}
;
defineSeed(464, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(465, 1, {}, CwMenuBar$$anon$3_0);
...
defineSeed(466, 1, {}, CwMenuBar$$anon$5_0);
...
defineSeed(467, 1, {}, CwMenuBar$$anon$7_0);
...
defineSeed(468, 1, {}, CwMenuBar$$anon$9_0);
...
defineSeed(469, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwMenuBar$$anonfun$onInitialize$1_0);
...
defineSeed(470, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwMenuBar$$anonfun$onInitialize$2_0);
...
defineSeed(471, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwMenuBar$$anonfun$onInitialize$3_0);
...
defineSeed(472, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwMenuBar$$anonfun$onInitialize$4_0);
...
defineSeed(473, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwMenuBar$$anonfun$onInitialize$5_0);
...
defineSeed(759, 326, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$PopupListener, Q$UIObject, Q$Widget]), MenuBar_0);
...
defineSeed(766, 327, makeCastMap([Q$HasVisibility, Q$MenuItem, Q$UIObject]), MenuItem_0, MenuItem_1, MenuItem_3);
function $$init_625(){
}
...
defineSeed(767, 327, makeCastMap([Q$HasVisibility, Q$MenuItemSeparator, Q$UIObject]), MenuItemSeparator_0);
function $intArrayOps(xs){
  return new ArrayOps$ofInt_0(xs);
}

defineSeed(986, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]));
_.filter_0 = function filter_0(p){
...
function iterator_21($this){
  return $this.scala$collection$GenIterableViewLike$Filtered$$$outer().iterator_1().filter_0($this.pred());
}
...
defineSeed(1008, 527, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), GenSeqViewLike$Filtered$$anonfun$index$2_0);
...
defineSeed(1010, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1_0);
...
_.filter_0 = function filter_1(p){
  return filter_10(this, p);
}
;
...
_.filter_0 = function filter_3(p){
  return filter_10(this, p);
}
;
...
_.filter_0 = function filter_4(p){
  return filter_10(this, p);
}
;
...
_.filter_0 = function filter_5(p){
  return filter_10(this, p);
}
;
...
defineSeed(1045, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), Iterator$$anon$22_0);
...
;
_.filter_0 = function filter_7(p){
  return filter_10(this, p);
}
;
...
_.filter_0 = function filter_8(p){
  return filter_10(this, p);
}
;
...
defineSeed(1047, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), Iterator$$anon$5_0);
...
;
_.filter_0 = function filter_9(p){
  return filter_10(this, p);
}
;
...
defineSeed(1048, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Iterator$$anonfun$toStream$1_0);
...
defineSeed(1052, 1, makeCastMap([Q$Serializable, Q$Equals, Q$ScalaObject, Q$Serializable_0, Q$GenTraversableOnce, Q$JavaConversions$JIteratorWrapper, Q$TraversableOnce]));
...
;
_.filter_2 = function filter_20(p){
...
;
_.filter_1 = function filter_23(p){
  return this.filter_2(p);
}
;
_.filter_2 = function filter_24(p){
  return filter_30(this, p);
}
;
...
;
_.filter_1 = function filter_25(p){
  return this.filter_2(p);
}
;
_.filter_2 = function filter_26(p){
  return filter_30(this, p);
}
;
...
;
_.filter_1 = function filter_27(p){
  return this.filter_2(p);
}
;
_.filter_2 = function filter_28(p){
  return filter_30(this, p);
}
;
...
defineSeed(1095, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), TraversableLike$$anonfun$flatMap$1_0);
...
defineSeed(1102, 1, makeCastMap([Q$ScalaObject, Q$Builder]), TraversableView$NoBuilder_0);
...
defineSeed(1123, 1, makeCastMap([Q$ScalaObject]), SliceInterval_0);
_.from$u0020 = 0;
_.until$u0020 = 0;
...
defineSeed(1124, 1, makeCastMap([Q$ScalaObject]), SliceInterval$_0);
var MODULE$_18;
...
defineSeed(1154, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), List$$anonfun$toStream$1_0);
...
defineSeed(1193, 1073, makeCastMap([Q$ScalaObject]), Stream$_0);
...
defineSeed(1195, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$1_0);
...
defineSeed(1196, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$append$1_0);
...
defineSeed(1197, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$filteredTail$1_0);
...
defineSeed(1198, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$flatMap$1_0);
...
defineSeed(1199, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$from$1_0);
...
defineSeed(1200, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$take$1_0);
...
defineSeed(1201, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), Stream$$anonfun$take$2_0);
...
defineSeed(1204, 1, makeCastMap([Q$ScalaObject]), Stream$ConsWrapper_0);
_.tl = null;
...
defineSeed(1206, 1207, makeCastMap([Q$ScalaObject, Q$Stream$StreamBuilder, Q$Builder]), Stream$StreamBuilder_0);
...
defineSeed(1208, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), Stream$StreamBuilder$$anonfun$result$1_0);
...
defineSeed(1209, 1109, makeCastMap([Q$ScalaObject]), Stream$StreamCanBuildFrom_0);
...
defineSeed(1210, 1, makeCastMap([Q$ScalaObject]), Stream$cons$_0);
var MODULE$_40;
function $$init_962(){
}
...
defineSeed(1211, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), StreamIterator_0);
...
;
_.filter_0 = function filter_51(p){
  return filter_10(this, p);
}
;
...
defineSeed(1212, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$2_0);
...
defineSeed(1213, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$next$1_0);
...
defineSeed(1214, 996, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0]), StreamIterator$$anonfun$toStream$1_0);
_.apply_3 = function apply_196(){
  return $apply_125();
}
;
function $$init_966(this$static){
}
...
defineSeed(1215, 1, makeCastMap([Q$ScalaObject]), StreamIterator$LazyCell_0);
_.bitmap$0 = 0;
_.st = null;
_.v$u0020 = null;
...
_.filter_0 = function filter_55(p){
  return filter_10(this, p);
}
;
...
defineSeed(1231, 1230, makeCastMap([Q$Serializable, Q$ScalaObject, Q$Serializable_0, Q$ArrayBuilder$ofInt, Q$Builder]), ArrayBuilder$ofInt_0);
...
defineSeed(1235, 1234, makeCastMap([Q$Equals, Q$ScalaObject, Q$GenIterableLike, Q$GenTraversableLike, Q$GenTraversableOnce, Q$IndexedSeqLike, Q$IterableLike, Q$TraversableLike, Q$TraversableOnce, Q$FilterMonadic, Q$HasNewBuilder, Q$IndexedSeqLike_0]), ArrayOps$ofInt_0);
...
_.filter_0 = function filter_59(p){
  return filter_10(this, p);
}
;
...
;
_.filter_1 = function filter_61(p){
  return this.filter_3(p);
}
;
_.filter_2 = function filter_62(p){
  return this.filter_3(p);
}
;
_.filter_3 = function filter_63(p){
...
defineSeed(1258, 1, makeCastMap([Q$ScalaObject]), IndexedSeqView$_0);
var MODULE$_48;
function $$init_995(this$static){
}
...
;
_.filter_1 = function filter_64(p){
  return this.filter_3(p);
}
;
_.filter_2 = function filter_65(p){
  return this.filter_3(p);
}
;
_.filter_3 = function filter_66(p){
  return filter_73(this, p);
}
;
...
;
_.filter_1 = function filter_67(p){
  return this.filter_3(p);
}
;
_.filter_2 = function filter_68(p){
  return this.filter_3(p);
}
;
_.filter_3 = function filter_69(p){
  return filter_73(this, p);
}
;
...
;
_.filter_1 = function filter_70(p){
  return this.filter_3(p);
}
;
_.filter_2 = function filter_71(p){
  return this.filter_3(p);
}
;
_.filter_3 = function filter_72(p){
  return filter_73(this, p);
}
;
...
defineSeed(1262, 1, {}, IndexedSeqView$$anon$7_0);
...
_.filter_0 = function filter_78(p){
  return filter_10(this, p);
}
;
...
;
var Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$1', 462, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$3', 465, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$1', 469, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$5_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$5', 466, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqView$_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$', 1258, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$2', 470, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$7_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$7', 467, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$3', 471, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$9_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$9', 468, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$4_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$4', 472, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_MenuItemSeparator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MenuItemSeparator', 767, Lcom_google_gwt_user_client_ui_UIObject_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anon$11_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anon$11', 463, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwMenuBar$$anonfun$onInitialize$5_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwMenuBar$$anonfun$onInitialize$5', 473, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$7_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$7', 1262, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqLike$$anon$1_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqLike$$anon$1', 1256, Ljava_lang_Object_2_classLit), Lscala_collection_TraversableView$NoBuilder_2_classLit = createForClass('scala.collection.', 'TraversableView$NoBuilder', 1102, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$', 1193, Lscala_collection_generic_SeqFactory_2_classLit), Lscala_collection_immutable_Stream_2_classLit = createForClass('scala.collection.immutable.', 'Stream', 1192, Ljava_lang_Object_2_classLit), Lscala_collection_generic_SliceInterval$_2_classLit = createForClass('scala.collection.generic.', 'SliceInterval$', 1124, Ljava_lang_Object_2_classLit), Lscala_collection_generic_SliceInterval_2_classLit = createForClass('scala.collection.generic.', 'SliceInterval', 1123, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$cons$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$cons$', 1210, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$$anonfun$from$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$from$1', 1199, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$Cons_2_classLit = createForClass('scala.collection.immutable.', 'Stream$Cons', 1203, Lscala_collection_immutable_Stream_2_classLit), Lscala_collection_SeqViewLike$$anon$9_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$9', 1083, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$StreamCanBuildFrom_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamCanBuildFrom', 1209, Lscala_collection_generic_GenTraversableFactory$GenericCanBuildFrom_2_classLit), Lscala_collection_mutable_LazyBuilder_2_classLit = createForClass('scala.collection.mutable.', 'LazyBuilder', 1207, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$StreamBuilder_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamBuilder', 1206, Lscala_collection_mutable_LazyBuilder_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$2_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$2', 1260, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$1_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$1', 1259, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$Empty$_2_classLit = createForClass('scala.collection.immutable.', 'Stream$Empty$', 1205, Lscala_collection_immutable_Stream_2_classLit), Lscala_collection_immutable_StreamIterator_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator', 1211, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_List$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.immutable.', 'List$$anonfun$toStream$1', 1154, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$StreamBuilder$$anonfun$result$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$StreamBuilder$$anonfun$result$1', 1208, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_immutable_StreamIterator$LazyCell_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$LazyCell', 1215, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$2_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$2', 1212, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$take$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$take$1', 1200, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$take$2_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$take$2', 1201, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_Iterator$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.', 'Iterator$$anonfun$toStream$1', 1048, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$flatMap$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$flatMap$1', 1198, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$next$1_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$next$1', 1213, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_StreamIterator$$anonfun$toStream$1_2_classLit = createForClass('scala.collection.immutable.', 'StreamIterator$$anonfun$toStream$1', 1214, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_immutable_Stream$$anonfun$filteredTail$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$filteredTail$1', 1197, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_Iterator$$anon$5_2_classLit = createForClass('scala.collection.', 'Iterator$$anon$5', 1047, Ljava_lang_Object_2_classLit), Lscala_collection_TraversableLike$$anonfun$flatMap$1_2_classLit = createForClass('scala.collection.', 'TraversableLike$$anonfun$flatMap$1', 1095, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_immutable_Stream$$anonfun$append$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$append$1', 1196, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_GenSeqViewLike$Filtered$$anonfun$index$2_2_classLit = createForClass('scala.collection.', 'GenSeqViewLike$Filtered$$anonfun$index$2', 1008, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lscala_collection_mutable_ArrayOps$ofInt_2_classLit = createForClass('scala.collection.mutable.', 'ArrayOps$ofInt', 1235, Lscala_collection_mutable_ArrayOps_2_classLit), Lscala_collection_SeqViewLike$$anon$6_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$6', 1082, Ljava_lang_Object_2_classLit), Lscala_collection_SeqViewLike$$anon$5_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$5', 1081, Ljava_lang_Object_2_classLit), Lscala_collection_mutable_ArrayBuilder$ofInt_2_classLit = createForClass('scala.collection.mutable.', 'ArrayBuilder$ofInt', 1231, Lscala_collection_mutable_ArrayBuilder_2_classLit), Lscala_collection_Iterator$$anon$22_2_classLit = createForClass('scala.collection.', 'Iterator$$anon$22', 1045, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$ConsWrapper_2_classLit = createForClass('scala.collection.immutable.', 'Stream$ConsWrapper', 1204, Ljava_lang_Object_2_classLit), Lscala_collection_immutable_Stream$$anonfun$1_2_classLit = createForClass('scala.collection.immutable.', 'Stream$$anonfun$1', 1195, Lscala_runtime_AbstractFunction0_2_classLit), Lscala_collection_mutable_IndexedSeqView$$anon$5_2_classLit = createForClass('scala.collection.mutable.', 'IndexedSeqView$$anon$5', 1261, Ljava_lang_Object_2_classLit), Lscala_collection_SeqViewLike$$anon$11_2_classLit = createForClass('scala.collection.', 'SeqViewLike$$anon$11', 1079, Ljava_lang_Object_2_classLit), Lscala_collection_GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1_2_classLit = createForClass('scala.collection.', 'GenSeqViewLike$Reversed$$anonfun$createReversedIterator$1', 1010, Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(10);
