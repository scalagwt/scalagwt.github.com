...
defineSeed(223, 224, makeCastMap([Q$Map]), ConstantMap_0);
...
defineSeed(225, 226, makeCastMap([Q$Iterable, Q$Collection, Q$Set]), ConstantMap$1_0);
...
defineSeed(228, 1, {}, ConstantMap$1$1_0);
...
defineSeed(229, 226, makeCastMap([Q$Iterable, Q$Collection, Q$Set]), ConstantMap$2_0);
...
defineSeed(230, 1, makeCastMap([Q$Map$Entry]), ConstantMap$EntryImpl_0);
...
function $onInitialize(this$static){
  ...
  dynamicCast($mapAsScalaMap(($clinit_JavaConversions$() , MODULE$_14 , colorMap)).filter_1(new CwConstantsExample$$anonfun$onInitialize$2_0), Q$IterableLike).foreach(new CwConstantsExample$$anonfun$onInitialize$3_0(colorBox$1));
  $setHTML_2(layout, 3, 0, exampleConstants.favoriteColor());
  $setWidget_2(layout, 3, 1, colorBox$1);
  return layout;
}

defineSeed(417, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(418, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwConstantsExample$$anonfun$onInitialize$1_0);
...
defineSeed(419, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwConstantsExample$$anonfun$onInitialize$2_0);
...
defineSeed(420, 352, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwConstantsExample$$anonfun$onInitialize$3_0);
...
defineSeed(452, 1, {}, ExampleConstants__0);
...
defineSeed(939, 754, makeCastMap([Q$Serializable, Q$Iterable, Q$Collection, Q$List, Q$RandomAccess]), Arrays$ArrayList_0);
...
defineSeed(1054, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), JavaConversions$JMapWrapperLike$$anon$2_0);
...
var Lcom_google_gwt_sample_showcase_client_content_i18n_ExampleConstants_1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'ExampleConstants_', 452, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsExample$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsExample$$anonfun$onInitialize$1', 418, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsExample$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsExample$$anonfun$onInitialize$2', 419, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsExample$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsExample$$anonfun$onInitialize$3', 420, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_JavaConversions$JMapWrapper_2_classLit = createForClass('scala.collection.', 'JavaConversions$JMapWrapper', 1053, Ljava_lang_Object_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap', 223, Ljava_util_AbstractMap_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$EntryImpl_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$EntryImpl', 230, Ljava_lang_Object_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$1_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$1', 225, Ljava_util_AbstractSet_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$1$1_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$1$1', 228, Ljava_lang_Object_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$2_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$2', 229, Ljava_util_AbstractSet_2_classLit), Lscala_collection_JavaConversions$JMapWrapperLike$$anon$2_2_classLit = createForClass('scala.collection.', 'JavaConversions$JMapWrapperLike$$anon$2', 1054, Ljava_lang_Object_2_classLit), Ljava_util_Arrays$ArrayList_2_classLit = createForClass('java.util.', 'Arrays$ArrayList', 939, Ljava_util_AbstractList_2_classLit);
$entry(onLoad)(32);
