...
defineSeed(294, 1, makeCastMap([Q$Serializable, Q$Comparable, Q$Date]));
...
defineSeed(495, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(496, 1, {}, CwSuggestBox$$anon$2_0);
...
defineSeed(497, 351, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwSuggestBox$$anonfun$onInitialize$1_0);
...
defineSeed(757, 758, {}, MultiWordSuggestOracle_0);
...
defineSeed(759, 1, makeCastMap([Q$SuggestOracle$Suggestion]), MultiWordSuggestOracle$MultiWordSuggestion_0);
...
defineSeed(760, 1, makeCastMap([Q$MultiWordSuggestOracle$WordBounds, Q$Comparable]), MultiWordSuggestOracle$WordBounds_0);
...
defineSeed(774, 226, makeCastMap([Q$Iterable, Q$Collection]), PrefixTree_0, PrefixTree_1);
...
defineSeed(775, 1, {}, PrefixTree$PrefixTreeIterator_0);
...
defineSeed(788, 324, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsRenderable, Q$IsWidget, Q$UIObject, Q$Widget]), SuggestBox_0);
...
defineSeed(789, 1, {}, SuggestBox$1_0);
...
defineSeed(790, 111, makeCastMap([Q$KeyDownHandler, Q$KeyPressHandler, Q$KeyUpHandler, Q$ValueChangeHandler, Q$EventHandler]), SuggestBox$1TextBoxEvents_0);
...
defineSeed(791, 1, {}, SuggestBox$2_0);
...
defineSeed(792, 793, {}, SuggestBox$DefaultSuggestionDisplay_0);
...
defineSeed(794, 1, makeCastMap([Q$Command]), SuggestBox$DefaultSuggestionDisplay$1_0);
...
defineSeed(795, 748, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$PopupListener, Q$UIObject, Q$Widget]), SuggestBox$SuggestionMenu_0);
function $$init_657(){
}
...
defineSeed(796, 755, makeCastMap([Q$HasVisibility, Q$MenuItem, Q$SuggestBox$SuggestionMenuItem, Q$UIObject]), SuggestBox$SuggestionMenuItem_0);
_.suggestion = null;
...
defineSeed(797, 1, {}, SuggestOracle$Request_0);
_.limit = 20;
_.query = null;
function $$init_659(this$static){
}
...
defineSeed(798, 1, {}, SuggestOracle$Response_0);
...
defineSeed(878, 1, makeCastMap([Q$Serializable, Q$Boolean, Q$Comparable]));
...
defineSeed(879, 880, makeCastMap([Q$Serializable, Q$Byte, Q$Comparable, Q$Number]));
...
defineSeed(882, 1, makeCastMap([Q$Serializable, Q$Character, Q$Comparable]));
...
defineSeed(886, 880, makeCastMap([Q$Serializable, Q$Comparable, Q$Double, Q$Number]));
...
defineSeed(887, 880, makeCastMap([Q$Serializable, Q$Comparable, Q$Float, Q$Number]));
...
defineSeed(891, 880, makeCastMap([Q$Serializable, Q$Comparable, Q$Integer, Q$Number]));
...
defineSeed(893, 880, makeCastMap([Q$Serializable, Q$Comparable, Q$Long, Q$Number]));
...
defineSeed(899, 880, makeCastMap([Q$Serializable, Q$Comparable, Q$Number, Q$Short]));
...
;
defineSeed(931, 929, makeCastMap([Q$Iterable, Q$Collection, Q$List]));
...
defineSeed(940, 1, {}, Comparators$1_0);
...
defineSeed(1363, 1299, makeCastMap([Q$Serializable, Q$Comparable, Q$Number, Q$ScalaObject, Q$ScalaNumber]));
...
;
var Lcom_google_gwt_user_client_ui_SuggestOracle_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestOracle', 758, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_MultiWordSuggestOracle_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MultiWordSuggestOracle', 757, Lcom_google_gwt_user_client_ui_SuggestOracle_2_classLit), Lcom_google_gwt_user_client_ui_MultiWordSuggestOracle$MultiWordSuggestion_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MultiWordSuggestOracle$MultiWordSuggestion', 759, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_MultiWordSuggestOracle$WordBounds_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MultiWordSuggestOracle$WordBounds', 760, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestOracle$Request_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestOracle$Request', 797, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestOracle$Response_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestOracle$Response', 798, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox', 788, Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionDisplay_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$SuggestionDisplay', 793, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$DefaultSuggestionDisplay_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$DefaultSuggestionDisplay', 792, Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionDisplay_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionMenu_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$SuggestionMenu', 795, Lcom_google_gwt_user_client_ui_MenuBar_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionMenuItem_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$SuggestionMenuItem', 796, Lcom_google_gwt_user_client_ui_MenuItem_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$DefaultSuggestionDisplay$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$DefaultSuggestionDisplay$1', 794, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$1', 789, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$2_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$2', 791, Ljava_lang_Object_2_classLit), Lcom_google_gwt_event_dom_client_HandlesAllKeyEvents_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'HandlesAllKeyEvents', 111, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$1TextBoxEvents_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$1TextBoxEvents', 790, Lcom_google_gwt_event_dom_client_HandlesAllKeyEvents_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwSuggestBox$$anon$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwSuggestBox$$anon$2', 496, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwSuggestBox$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwSuggestBox$$anonfun$onInitialize$1', 497, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_PrefixTree_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'PrefixTree', 774, Ljava_util_AbstractCollection_2_classLit), Lcom_google_gwt_user_client_ui_PrefixTree$PrefixTreeIterator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'PrefixTree$PrefixTreeIterator', 775, Ljava_lang_Object_2_classLit), Lcom_google_gwt_event_dom_client_KeyPressEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'KeyPressEvent', 115, Lcom_google_gwt_event_dom_client_KeyEvent_2_classLit), Lcom_google_gwt_safehtml_shared_SafeHtmlBuilder_2_classLit = createForClass('com.google.gwt.safehtml.shared.', 'SafeHtmlBuilder', 316, Ljava_lang_Object_2_classLit), Ljava_util_Comparators$1_2_classLit = createForClass('java.util.', 'Comparators$1', 940, Ljava_lang_Object_2_classLit);
$entry(onLoad)(8);
