...
defineSeed(297, 1, makeCastMap([Q$Serializable, Q$Comparable, Q$Date]));
_.compareTo$ = function compareTo_0(other){
  return $compareTo_0(this, dynamicCast(other, Q$Date));
}
;
function $$init_259(this$static){
...
defineSeed(498, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(499, 1, {}, CwSuggestBox$$anon$2_0);
...
defineSeed(500, 354, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwSuggestBox$$anonfun$onInitialize$1_0);
...
defineSeed(762, 763, {}, MultiWordSuggestOracle_0);
...
defineSeed(764, 1, makeCastMap([Q$SuggestOracle$Suggestion]), MultiWordSuggestOracle$MultiWordSuggestion_0);
...
defineSeed(765, 1, makeCastMap([Q$MultiWordSuggestOracle$WordBounds, Q$Comparable]), MultiWordSuggestOracle$WordBounds_0);
...
defineSeed(779, 229, makeCastMap([Q$Iterable, Q$Collection]), PrefixTree_0, PrefixTree_1);
...
defineSeed(780, 1, {}, PrefixTree$PrefixTreeIterator_0);
...
defineSeed(793, 327, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsRenderable, Q$IsWidget, Q$UIObject, Q$Widget]), SuggestBox_0);
...
defineSeed(794, 1, {}, SuggestBox$1_0);
...
defineSeed(795, 114, makeCastMap([Q$KeyDownHandler, Q$KeyPressHandler, Q$KeyUpHandler, Q$ValueChangeHandler, Q$EventHandler]), SuggestBox$1TextBoxEvents_0);
...
defineSeed(796, 1, {}, SuggestBox$2_0);
...
defineSeed(797, 798, {}, SuggestBox$DefaultSuggestionDisplay_0);
...
defineSeed(799, 1, makeCastMap([Q$Command]), SuggestBox$DefaultSuggestionDisplay$1_0);
...
defineSeed(800, 753, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$IsWidget, Q$PopupListener, Q$UIObject, Q$Widget]), SuggestBox$SuggestionMenu_0);
function $$init_661(){
}
...
defineSeed(801, 760, makeCastMap([Q$HasVisibility, Q$MenuItem, Q$SuggestBox$SuggestionMenuItem, Q$UIObject]), SuggestBox$SuggestionMenuItem_0);
_.suggestion = null;
function $$init_662(this$static){
}
...
defineSeed(802, 1, {}, SuggestOracle$Request_0);
_.limit = 20;
_.query = null;
function $$init_663(this$static){
}
...
defineSeed(803, 1, {}, SuggestOracle$Response_0);
...
defineSeed(883, 1, makeCastMap([Q$Serializable, Q$Boolean, Q$Comparable]));
...
defineSeed(884, 885, makeCastMap([Q$Serializable, Q$Byte, Q$Comparable, Q$Number]));
...
defineSeed(887, 1, makeCastMap([Q$Serializable, Q$Character, Q$Comparable]));
...
defineSeed(891, 885, makeCastMap([Q$Serializable, Q$Comparable, Q$Double, Q$Number]));
...
defineSeed(892, 885, makeCastMap([Q$Serializable, Q$Comparable, Q$Float, Q$Number]));
...
defineSeed(896, 885, makeCastMap([Q$Serializable, Q$Comparable, Q$Integer, Q$Number]));
...
defineSeed(898, 885, makeCastMap([Q$Serializable, Q$Comparable, Q$Long, Q$Number]));
...
defineSeed(904, 885, makeCastMap([Q$Serializable, Q$Comparable, Q$Number, Q$Short]));
...
;
defineSeed(936, 934, makeCastMap([Q$Iterable, Q$Collection, Q$List]));
...
defineSeed(945, 1, {}, Comparators$1_0);
...
defineSeed(1368, 1304, makeCastMap([Q$Serializable, Q$Comparable, Q$Number, Q$ScalaObject, Q$ScalaNumber]));
...
;
var Lcom_google_gwt_user_client_ui_SuggestOracle_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestOracle', 763, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_MultiWordSuggestOracle_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MultiWordSuggestOracle', 762, Lcom_google_gwt_user_client_ui_SuggestOracle_2_classLit), Lcom_google_gwt_user_client_ui_MultiWordSuggestOracle$MultiWordSuggestion_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MultiWordSuggestOracle$MultiWordSuggestion', 764, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_MultiWordSuggestOracle$WordBounds_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'MultiWordSuggestOracle$WordBounds', 765, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestOracle$Request_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestOracle$Request', 802, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestOracle$Response_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestOracle$Response', 803, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox', 793, Lcom_google_gwt_user_client_ui_Composite_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionDisplay_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$SuggestionDisplay', 798, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$DefaultSuggestionDisplay_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$DefaultSuggestionDisplay', 797, Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionDisplay_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionMenu_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$SuggestionMenu', 800, Lcom_google_gwt_user_client_ui_MenuBar_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$SuggestionMenuItem_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$SuggestionMenuItem', 801, Lcom_google_gwt_user_client_ui_MenuItem_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$DefaultSuggestionDisplay$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$DefaultSuggestionDisplay$1', 799, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$1', 794, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$2_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$2', 796, Ljava_lang_Object_2_classLit), Lcom_google_gwt_event_dom_client_HandlesAllKeyEvents_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'HandlesAllKeyEvents', 114, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_SuggestBox$1TextBoxEvents_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'SuggestBox$1TextBoxEvents', 795, Lcom_google_gwt_event_dom_client_HandlesAllKeyEvents_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwSuggestBox$$anon$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwSuggestBox$$anon$2', 499, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwSuggestBox$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwSuggestBox$$anonfun$onInitialize$1', 500, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_user_client_ui_PrefixTree_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'PrefixTree', 779, Ljava_util_AbstractCollection_2_classLit), Lcom_google_gwt_user_client_ui_PrefixTree$PrefixTreeIterator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'PrefixTree$PrefixTreeIterator', 780, Ljava_lang_Object_2_classLit), Lcom_google_gwt_event_dom_client_KeyPressEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'KeyPressEvent', 118, Lcom_google_gwt_event_dom_client_KeyEvent_2_classLit), Lcom_google_gwt_safehtml_shared_SafeHtmlBuilder_2_classLit = createForClass('com.google.gwt.safehtml.shared.', 'SafeHtmlBuilder', 319, Ljava_lang_Object_2_classLit), Ljava_util_Comparators$1_2_classLit = createForClass('java.util.', 'Comparators$1', 945, Ljava_lang_Object_2_classLit);
$entry(onLoad)(8);
