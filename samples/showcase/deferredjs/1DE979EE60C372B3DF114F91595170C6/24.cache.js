...
defineSeed(545, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(546, 529, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwHorizontalSplitPanel$$anonfun$onInitialize$1_0);
...
function $$init_600(this$static){
  this$static.impl = new HorizontalSplitPanel$ImplSafari_0;
}
...
defineSeed(734, 735, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$HasWidgets$ForIsWidget, Q$IsWidget, Q$Panel, Q$UIObject, Q$Widget, Q$Iterable]), HorizontalSplitPanel_0);
...
defineSeed(736, 1, makeCastMap([Q$Command]), HorizontalSplitPanel$1_0);
...
function HorizontalSplitPanel$ImplSafari_0(){
  HorizontalSplitPanel$Impl_0.call(this);
  $$init_603();
}

defineSeed(738, 737, {}, HorizontalSplitPanel$ImplSafari_0);
_.init_1 = function init_5(panel){
  this.panel = panel;
  '100%';
  $init_1(this, panel);
  setHeight_1(panel.container, '100%');
  setHeight_1($getElement_1(panel, 0), '100%');
  setHeight_1($getElement_1(panel, 1), '100%');
  setHeight_1($getSplitElement(panel), '100%');
}
;
function $clinit_HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator(){
  ...
  _instance0_4 = new HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator_0;
...
defineSeed(739, 1, {}, HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator_0);
...
function $clinit_HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator$horizontalSplitPanelThumbInitializer(){
  ...
  $horizontalSplitPanelThumbInitializer(($clinit_HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator() , _instance0_4));
}
...
var Lcom_google_gwt_user_client_ui_HorizontalSplitPanel_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel', 734, Lcom_google_gwt_user_client_ui_SplitPanel_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel$Impl_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel$Impl', 737, Ljava_lang_Object_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel$ImplSafari_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel$ImplSafari', 738, Lcom_google_gwt_user_client_ui_HorizontalSplitPanel$Impl_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel$1_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel$1', 736, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_panels_CwHorizontalSplitPanel$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.panels.', 'CwHorizontalSplitPanel$$anonfun$onInitialize$1', 546, Lscala_runtime_AbstractFunction1$mcVI$sp_2_classLit), Lcom_google_gwt_user_client_ui_HorizontalSplitPanel_1Resources_1en_1InlineClientBundleGenerator_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'HorizontalSplitPanel_Resources_en_InlineClientBundleGenerator', 739, Ljava_lang_Object_2_classLit);
$entry(onLoad)(24);
