...
function $flatMap(this$static, f$2, bf){
  ...
  if ($scala$collection$immutable$Stream$$isStreamBuilder(this$static, bf)) {
    if (this$static.isEmpty()) {
      ...
      dynamicCast(nonEmptyPrefix$1.elem, Q$Stream).isEmpty()?($13$ = $empty_7(($clinit_Stream$() , MODULE$_31))):($13$ = $append_7(prefix, new Stream$$anonfun$flatMap$1_0(this$static, f$2, nonEmptyPrefix$1)));
      $12$ = $13$;
    }
