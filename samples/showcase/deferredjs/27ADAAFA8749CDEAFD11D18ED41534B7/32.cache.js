...
defineSeed(183, 184, makeCastMap([Q$Map]), ConstantMap_0);
...
defineSeed(185, 186, makeCastMap([Q$Iterable, Q$Collection, Q$Set]), ConstantMap$1_0);
...
defineSeed(188, 1, {}, ConstantMap$1$1_0);
...
defineSeed(189, 186, makeCastMap([Q$Iterable, Q$Collection, Q$Set]), ConstantMap$2_0);
...
defineSeed(190, 1, makeCastMap([Q$Map$Entry]), ConstantMap$EntryImpl_0);
...
defineSeed(333, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(334, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwConstantsExample$$anonfun$onInitialize$1_0);
...
defineSeed(335, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwConstantsExample$$anonfun$onInitialize$2_0);
...
defineSeed(336, 268, makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]), CwConstantsExample$$anonfun$onInitialize$3_0);
...
defineSeed(368, 1, {}, ExampleConstants__0);
...
defineSeed(847, 667, makeCastMap([Q$Serializable, Q$Iterable, Q$Collection, Q$List, Q$RandomAccess]), Arrays$ArrayList_0);
...
defineSeed(962, 1, makeCastMap([Q$ScalaObject, Q$GenTraversableOnce, Q$TraversableOnce]), JavaConversions$JMapWrapperLike$$anon$2_0);
...
var Lcom_google_gwt_sample_showcase_client_content_i18n_ExampleConstants_1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'ExampleConstants_', 368, Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsExample$$anonfun$onInitialize$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsExample$$anonfun$onInitialize$1', 334, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsExample$$anonfun$onInitialize$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsExample$$anonfun$onInitialize$2', 335, Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_i18n_CwConstantsExample$$anonfun$onInitialize$3_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.i18n.', 'CwConstantsExample$$anonfun$onInitialize$3', 336, Lscala_runtime_AbstractFunction1_2_classLit), Lscala_collection_JavaConversions$JMapWrapper_2_classLit = createForClass('scala.collection.', 'JavaConversions$JMapWrapper', 961, Ljava_lang_Object_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap', 183, Ljava_util_AbstractMap_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$EntryImpl_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$EntryImpl', 190, Ljava_lang_Object_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$1_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$1', 185, Ljava_util_AbstractSet_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$1$1_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$1$1', 188, Ljava_lang_Object_2_classLit), Lcom_google_gwt_i18n_client_impl_ConstantMap$2_2_classLit = createForClass('com.google.gwt.i18n.client.impl.', 'ConstantMap$2', 189, Ljava_util_AbstractSet_2_classLit), Lscala_collection_JavaConversions$JMapWrapperLike$$anon$2_2_classLit = createForClass('scala.collection.', 'JavaConversions$JMapWrapperLike$$anon$2', 962, Ljava_lang_Object_2_classLit), Ljava_util_Arrays$ArrayList_2_classLit = createForClass('java.util.', 'Arrays$ArrayList', 847, Ljava_util_AbstractList_2_classLit);
$entry(onLoad)(32);
