...
function OpenHandlers$$anon$7(){
}

_ = OpenHandlers$$anon$7_0.prototype = OpenHandlers$$anon$7.prototype = new Object_0;
_.getClass$ = function getClass_199(){
  return Lcom_google_gwt_sample_showcase_client_OpenHandlers$$anon$7_2_classLit;
}
;
...
;
_.castableTypeMap$ = makeCastMap([Q$OpenHandler, Q$EventHandler]);
_.fn$7 = null;
function $$init_199(){
}
...
function OpenHandlers$RichHasOpenHandlers(){
}

_ = OpenHandlers$RichHasOpenHandlers_0.prototype = OpenHandlers$RichHasOpenHandlers.prototype = new Object_0;
_.getClass$ = function getClass_200(){
  return Lcom_google_gwt_sample_showcase_client_OpenHandlers$RichHasOpenHandlers_2_classLit;
}
;
...
function $createDynamicTree(this$static){
  ...
  $foreach($until_0($intWrapper(($clinit_Predef$() , MODULE$_12 , 0)), 5), new CwTree$$anonfun$createDynamicTree$1_0(this$static, dynamicTree$1));
  $onOpen(($clinit_Handlers$() , MODULE$_2).enrichHasOpenHandlers(dynamicTree$1), new CwTree$$anonfun$createDynamicTree$2_0);
...
function $createStaticTree(this$static){
  ...
  $apply_95(($clinit_List$() , MODULE$_21 , $wrapRefArray(($clinit_Predef$() , MODULE$_12 , initValues(_3Lscala_Tuple2_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1, Q$Equals_$1, Q$ScalaObject_$1]), Q$Tuple2, [$$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , concertosLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBeethovenWorkConcertos()), $$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , quartetsLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBeethovenWorkQuartets()), $$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , sonatasLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBeethovenWorkSonatas()), $$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , symphoniesLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBeethovenWorkSymphonies())]))))).foreach($addMusicSection(beethovenItem).tupled());
  brahmsItem = $addItem_4(staticTree, composers[1]);
  $apply_95(($clinit_List$() , MODULE$_21 , $wrapRefArray(($clinit_Predef$() , MODULE$_12 , initValues(_3Lscala_Tuple2_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1, Q$Equals_$1, Q$ScalaObject_$1]), Q$Tuple2, [$$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , concertosLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBrahmsWorkConcertos()), $$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , quartetsLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBrahmsWorkQuartets()), $$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , sonatasLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBrahmsWorkSonatas()), $$minus$greater($any2ArrowAssoc(($clinit_Predef$() , MODULE$_12 , symphoniesLabel)), $com$google$gwt$sample$showcase$client$content$lists$CwTree$$constants(this$static).cwTreeBrahmsWorkSymphonies())]))))).foreach($addMusicSection(brahmsItem).tupled());
...
function $apply_34(this$static, label, composerWorks){
  var section$1;
  section$1 = $addItem_6(this$static.parent$1, label);
  $refArrayOps(($clinit_Predef$() , MODULE$_12 , composerWorks)).foreach(new CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1_0(section$1));
}
...
function CwTree$$anonfun$addMusicSection$1(){
}

_ = CwTree$$anonfun$addMusicSection$1_0.prototype = CwTree$$anonfun$addMusicSection$1.prototype = new AbstractFunction2;
_.apply_1 = function apply_35(v1, v2){
  $apply_34(this, dynamicCast(v1, Q$String), dynamicCast(v2, Q$String_$1));
  return $clinit_BoxedUnit() , UNIT;
}
;
_.getClass$ = function getClass_299(){
  return Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$addMusicSection$1_2_classLit;
}
;
...
function $apply_35(this$static, work){
...
function CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1(){
}

_ = CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1_0.prototype = CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1.prototype = new AbstractFunction1;
_.apply_0 = function apply_36(v1){
  return $apply_35(this, dynamicCast(v1, Q$String));
}
;
_.getClass$ = function getClass_300(){
  return Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1_2_classLit;
}
;
...
function $apply_36(this$static, i){
  var item;
...
function CwTree$$anonfun$createDynamicTree$1(){
}

_ = CwTree$$anonfun$createDynamicTree$1_0.prototype = CwTree$$anonfun$createDynamicTree$1.prototype = new AbstractFunction1;
_.apply_0 = function apply_37(v1){
  return $apply_36(this, unboxToInt(v1));
}
;
_.getClass$ = function getClass_301(){
  return Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$createDynamicTree$1_2_classLit;
}
;
_.castableTypeMap$ = makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]);
_.$outer$u0020 = null;
...
function $apply_37(event_0){
  ...
  if ($getChildCount_0(item$1) == 1) {
    ...
    $foreach($until_0($intWrapper(($clinit_Predef$() , MODULE$_12 , 0)), numChildren), new CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2_0(item$1, itemText$1));
...
function CwTree$$anonfun$createDynamicTree$2(){
}

_ = CwTree$$anonfun$createDynamicTree$2_0.prototype = CwTree$$anonfun$createDynamicTree$2.prototype = new AbstractFunction1;
_.apply_0 = function apply_38(v1){
  $apply_37(dynamicCast(v1, Q$OpenEvent));
  return $clinit_BoxedUnit() , UNIT;
}
;
_.getClass$ = function getClass_302(){
  return Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$createDynamicTree$2_2_classLit;
}
;
_.castableTypeMap$ = makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]);
function $$init_302(){
...
function $apply_38(this$static, i){
  var child;
...
function CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2(){
}

_ = CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2_0.prototype = CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2.prototype = new AbstractFunction1;
_.apply_0 = function apply_39(v1){
  return $apply_38(this, unboxToInt(v1));
}
;
_.getClass$ = function getClass_303(){
  return Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2_2_classLit;
}
;
_.castableTypeMap$ = makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]);
_.item$1 = null;
...
_ = Tree_0.prototype = Tree.prototype;
...
_ = Tree$ImageAdapter_0.prototype = Tree$ImageAdapter.prototype;
function $$init_690(){
}

function $apply_71(this$static, x0$1){
  var $1$, temp1;
  temp1 = x0$1;
  if (isNotNull(temp1)) {
...
function Function2$$anonfun$tupled$1(){
}

_ = Function2$$anonfun$tupled$1_0.prototype = Function2$$anonfun$tupled$1.prototype = new AbstractFunction1;
_.apply_0 = function apply_74(v1){
  return $apply_71(this, dynamicCast(v1, Q$Tuple2));
}
;
_.getClass$ = function getClass_692(){
  return Lscala_Function2$$anonfun$tupled$1_2_classLit;
}
;
_.castableTypeMap$ = makeCastMap([Q$Serializable, Q$Function1, Q$ScalaObject, Q$Serializable_0]);
_.$outer$u0020 = null;
...
function Predef$ArrowAssoc(){
}

_ = Predef$ArrowAssoc_0.prototype = Predef$ArrowAssoc.prototype = new Object_0;
_.getClass$ = function getClass_705(){
  return Lscala_Predef$ArrowAssoc_2_classLit;
}
;
_.castableTypeMap$ = makeCastMap([Q$ScalaObject]);
_.x$u0020 = null;
var _3Lscala_Tuple2_2_classLit = createForArray('[Lscala.', 'Tuple2;', 'Array_0', Lscala_Tuple2_2_classLit), Lscala_Predef$ArrowAssoc_2_classLit = createForClass('scala.', 'Predef$ArrowAssoc', 'Predef$ArrowAssoc', Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$createDynamicTree$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwTree$$anonfun$createDynamicTree$1', 'CwTree$$anonfun$createDynamicTree$1', Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_OpenHandlers$RichHasOpenHandlers_2_classLit = createForClass('com.google.gwt.sample.showcase.client.', 'OpenHandlers$RichHasOpenHandlers', 'OpenHandlers$RichHasOpenHandlers', Ljava_lang_Object_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$createDynamicTree$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwTree$$anonfun$createDynamicTree$2', 'CwTree$$anonfun$createDynamicTree$2', Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$addMusicSection$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwTree$$anonfun$addMusicSection$1', 'CwTree$$anonfun$addMusicSection$1', Lscala_runtime_AbstractFunction2_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2', 'CwTree$$anonfun$createDynamicTree$2$$anonfun$apply$2', Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_OpenHandlers$$anon$7_2_classLit = createForClass('com.google.gwt.sample.showcase.client.', 'OpenHandlers$$anon$7', 'OpenHandlers$$anon$7', Ljava_lang_Object_2_classLit), Lscala_Function2$$anonfun$tupled$1_2_classLit = createForClass('scala.', 'Function2$$anonfun$tupled$1', 'Function2$$anonfun$tupled$1', Lscala_runtime_AbstractFunction1_2_classLit), Lcom_google_gwt_sample_showcase_client_content_lists_CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1_2_classLit = createForClass('com.google.gwt.sample.showcase.client.content.lists.', 'CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1', 'CwTree$$anonfun$addMusicSection$1$$anonfun$apply$1', Lscala_runtime_AbstractFunction1_2_classLit);
$entry(onLoad)(9);
